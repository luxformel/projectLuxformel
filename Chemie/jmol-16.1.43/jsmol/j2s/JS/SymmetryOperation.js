...
Clazz.load (["JU.M4", "$.P3"], "JS.SymmetryOperation", ["java.lang.Boolean", "$.Character", "$.Float", "java.util.HashSet", "$.Hashtable", "JU.Lst", "$.Matrix", "$.Measure", "$.P4", "$.PT", "$.SB", "$.V3", "JS.Symmetry", "JU.BoxInfo", "$.Logger", "$.Parser"], function () {
...
x -= n;
}var n48 = Clazz.doubleToInt (Math.floor (x * 48 + 0.0001));
var div;
if (n48 % 48 == 0) {
div = 1;
} else if (n48 % 24 == 0) {
...
if (x24 / 24 == Clazz.doubleToInt (x24 / 24)) return m + (Clazz.doubleToInt (x24 / 24));
if (x24 % 8 != 0) {
...
c$.checkOpTrans = Clazz.defineMethod (c$, "checkOpTrans", 
 function (pt) {
return pt.lengthSquared () < 1;
}, "JU.T3");
c$.opClean = Clazz.defineMethod (c$, "opClean", 
function (t) {
...
c$.approxPt = Clazz.defineMethod (c$, "approxPt", 
function (pt) {
if (pt != null) {
...
Clazz.defineStatics (c$,
"C3codes",  Clazz.newIntArray (-1, [0x031112, 0x121301, 0x130112, 0x021311, 0x130102, 0x020311, 0x031102, 0x120301]));
