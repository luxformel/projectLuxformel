...
Clazz.load (["JU.P3", "$.V3"], "JS.SymmetryDesc", ["java.lang.Boolean", "$.Float", "java.util.Hashtable", "JU.BS", "$.Lst", "$.M4", "$.Measure", "$.P4", "$.PT", "$.Quat", "$.SB", "JM.Atom", "JS.T", "JS.SpaceGroup", "$.Symmetry", "$.SymmetryOperation", "JU.Escape", "$.Logger"], function () {
...
wp = "" + (90 - Clazz.floatToInt (JS.SymmetryDesc.vtemp.length () / pitch1 * 90));
