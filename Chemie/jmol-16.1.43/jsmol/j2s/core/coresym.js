...
Clazz_load (["J.api.SymmetryInterface"], "JS.Symmetry", ["JU.BS", "$.Lst", "$.M4", "$.P3", "$.PT", "J.api.Interface", "J.bspt.Bspt", "JS.PointGroup", "$.SpaceGroup", "$.SymmetryInfo", "$.SymmetryOperation", "$.UnitCell", "JU.Escape", "$.Logger", "$.SimpleUnitCell"], function () {
c$ = Clazz_decorateAsClass (function () {
...
return JS.SymmetryOperation.getMatrixFromString (null, xyz, rotTransMatrix, allowScaling, true);
}, "~S,~A,~B,~N");
...
if (sg == null) return "?";
}this.unitCell.toFractional (p = JU.P3.newP (p), true);
if (JS.Symmetry.wyckoffFinder == null) {
JS.Symmetry.wyckoffFinder = J.api.Interface.getInterface ("JS.WyckoffFinder", null, "symmetry");
}try {
return JS.Symmetry.wyckoffFinder.getWyckoffFinder (vwr, sg.intlTableNumberFull).getWyckoffPosition (p);
} catch (e) {
if (Clazz_exceptionOf (e, Exception)) {
e.printStackTrace ();
return "?";
...
JS.SymmetryOperation.getMatrixFromString (null, xyz, a, true, false);
a[3] /= 12;
a[7] /= 12;
a[11] /= 12;
...
Clazz_declarePackage ("JS");
Clazz_load (["JU.M4", "$.P3"], "JS.SymmetryOperation", ["java.lang.Boolean", "$.Character", "$.Float", "java.util.HashSet", "$.Hashtable", "JU.Lst", "$.Matrix", "$.Measure", "$.P4", "$.PT", "$.SB", "$.V3", "JS.Symmetry", "JU.BoxInfo", "$.Logger", "$.Parser"], function () {
c$ = Clazz_decorateAsClass (function () {
...
case 2:
return "Rot" + this.opOrder + JS.SymmetryOperation.op48 (this.opPoint) + JS.SymmetryOperation.op48 (this.opAxis);
case 4:
...
case 6:
return "Nbar" + this.opOrder + JS.SymmetryOperation.op48 (this.opPoint) + JS.SymmetryOperation.op48 (this.opAxis);
case 9:
...
return "reflection ";
case 3:
return "screw rotation " + this.opOrder + (this.opIsCCW === Boolean.TRUE ? "(+) " : "(-) ") + JS.SymmetryOperation.opFrac (this.opTrans);
case 6:
return this.opOrder + "-bar " + JS.SymmetryOperation.opFrac (this.opPoint);
case 9:
...
x -= n;
}var n48 = Clazz_doubleToInt (Math.floor (x * 48 + 0.0001));
var div;
if (n48 % 48 == 0) {
div = 1;
} else if (n48 % 24 == 0) {
...
allowScaling = false;
}var strOut = JS.SymmetryOperation.getMatrixFromString (this, xyz, this.linearRotTrans, allowScaling, halfOrLess);
...
function (xyz, halfOrLess) {
var linearRotTrans =  Clazz_newFloatArray (16, 0);
xyz = JS.SymmetryOperation.getMatrixFromString (null, xyz, linearRotTrans, false, halfOrLess);
...
function (xyz) {
try {
return JS.SymmetryOperation.getMatrixFromString (null, xyz, null, false, true);
} catch (e) {
if (Clazz_exceptionOf (e, Exception)) {
return null;
} else {
...
function (op, xyz, linearRotTrans, allowScaling, halfOrLess) {
...
}strT += JS.SymmetryOperation.plusMinus (strT, val, myLabels[ipt], false);
break;
case ',':
if (transPt != 0) {
if (transPt > 0) {
...
if (x24 / 24 == Clazz_doubleToInt (x24 / 24)) return m + (Clazz_doubleToInt (x24 / 24));
if (x24 % 8 != 0) {
...
for (var i = 0; i < 8; i++) if (c == JS.SymmetryOperation.C3codes[i]) return JS.SymmetryOperation.xneg;

return JS.SymmetryOperation.xpos;
}, "JU.M4");
...
var d = 0;
var p1 =  new JU.P3 ();
var p2 = JU.P3.newP (JS.SymmetryOperation.x);
m4.setM4 (this);
var p1sum =  new JU.P3 ();
var p2sum = JU.P3.newP (p2);
var p2odd =  new JU.P3 ();
var p2even = JU.P3.newP (p2);
var m4trans =  new JU.V3 ();
var p21 =  new JU.P3 ();
...
d = JS.SymmetryOperation.approx6 (m4trans.length ());
if (d > 0) {
this.opTrans = JU.V3.newV (m4trans);
...
p2sum.add2 (p2, px);
p2sum.scale (0.5);
this.opPoint = JU.P3.newP (JS.SymmetryOperation.opClean (p2sum));
isOK = JS.SymmetryOperation.checkOpPoint (this.opPoint);
break;
case 2:
this.rotTrans (p1);
p1.scale (1 / order);
d = JS.SymmetryOperation.approx6 (p1.length ());
v = JU.V3.newVsub (p2sum, p1sum);
v.normalize ();
this.opAxis = JS.SymmetryOperation.opClean (v);
p1sum.scale (1 / order);
p1.setT (p1sum);
if (d > 0) {
p2sum.setT (p1sum);
p1sum.sub (this.opTrans);
}this.opPoint = JU.P3.newP (JS.SymmetryOperation.opClean (p1sum));
if (d > 0) {
p1sum.add2 (this.opPoint, this.opTrans);
...
if (JS.SymmetryOperation.checkOpAxis (this.opPoint, this.opAxis, p1sum,  new JU.V3 (),  new JU.V3 (), this.opPoint)) {
this.opPoint2 = JU.P3.newP (p1sum);
}}break;
case 6:
p2odd.scale (2 / order);
...
case 8:
v = JU.V3.newVsub (p2, p1);
v.sub (JS.SymmetryOperation.x);
v.normalize ();
this.opAxis = JS.SymmetryOperation.opClean (v);
if (d > 0 && JS.SymmetryOperation.approx6 (v.dot (m4trans)) != 0) {
isOK = false;
break;
}p1sum.set (0, 0, 0);
var vt =  new JU.V3 ();
JS.SymmetryOperation.approx6 (JU.Measure.projectOntoAxis (p1, p1sum, v, vt));
this.opPoint = JU.P3.newP (vt);
this.opPoint.scale (0.5);
this.opPlane =  new JU.P4 ();
isOK = JS.SymmetryOperation.checkOpPlane (this.opPoint, v, this.opPlane);
v = null;
break;
}
if (isOK && v != null && (d >= 1 || v.dot (p1) < 0)) {
isOK = false;
}if (isOK && this.opTrans != null && d > 0) {
this.opType |= 1;
JS.SymmetryOperation.opClean (this.opTrans);
} else {
this.opTrans = null;
}if (!isOK || this.opTrans != null && !JS.SymmetryOperation.checkOpTrans (this.opTrans)) {
...
if (p != null && JS.SymmetryOperation.checkOpPoint (p) && axis.dot (t1) * f < 0 && (ptNot == null || ptNot.distance (p) >= 0.5)) {
return true;
}}
return false;
}, "JU.P3,JU.V3,JU.P3,JU.V3,JU.V3,JU.P3");
c$.checkOpTrans = Clazz_defineMethod (c$, "checkOpTrans", 
 function (pt) {
return pt.lengthSquared () < 1;
}, "JU.T3");
c$.opClean = Clazz_defineMethod (c$, "opClean", 
function (t) {
...
c$.checkOpPlane = Clazz_defineMethod (c$, "checkOpPlane", 
 function (p2sum, v, plane) {
JU.Measure.getPlaneThroughPoint (p2sum, v, plane);
plane.w = JS.SymmetryOperation.approx6 (plane.w);
var pts = JU.BoxInfo.unitCubePoints;
var nPos = 0;
var nNeg = 0;
for (var i = 8; --i >= 0; ) {
var d = JU.Measure.getPlaneProjection (pts[i], plane, p2sum, v);
...
var n = ops.length;
var lst =  new JU.Lst ();
var xyzLst =  new java.util.HashSet ();
...
xyzLst.add (s);
if ((op.getOpType () & 8) == 8) JS.SymmetryOperation.addPlaneMap (mapPlanes, op);
}
for (var i = 1; i < n; i++) {
...
function (xyzList, lst, mapPlanes, n0) {
var t0 =  new JU.V3 ();
...
}, "java.util.HashSet,JU.Lst,java.util.Map,~N");
...
var op0 = l.get (i);
if (op0.isCoincident || op0.getOpType () == 8) {
...
Clazz_defineMethod (c$, "opCheckAdd", 
 function (opThis, t0, n0, t, xyzList, lst) {
this.setM4 (opThis);
t.add (t0);
this.setTranslation (t);
this.opType = -1;
this.isIrrelevant = false;
var type = this.getOpType ();
if (!this.isIrrelevant && type != 0 && type != 1) {
...
}, "JS.SymmetryOperation,JU.V3,~N,JU.V3,java.util.HashSet,JU.Lst");
c$.approxPt = Clazz_defineMethod (c$, "approxPt", 
function (pt) {
if (pt != null) {
...
"TYPE_INVERSION", 4,
"TYPE_REFLECTION", 8,
"TYPE_SCREW_ROTATION", 3,
"TYPE_ROTOINVERSION", 6,
"TYPE_GLIDE_REFLECTION", 9,
"PLANE_MODE_POSITION_ONLY", 0,
"PLANE_MODE_NOTRANS", 1,
"PLANE_MODE_FULL", 2,
"DIVISOR_MASK", 0xFF,
"DIVISOR_OFFSET", 8,
...
c$.x = c$.prototype.x = JU.P3.new3 (3.141592653589793, 2.718281828459045, (8.539734222673566));
Clazz_defineStatics (c$,
"C3codes",  Clazz_newIntArray (-1, [0x031112, 0x121301, 0x130112, 0x021311, 0x130102, 0x020311, 0x031102, 0x120301]));
c$.xpos = c$.prototype.xpos = JU.P3.new3 (1, 0, 0);
c$.xneg = c$.prototype.xneg = JU.P3.new3 (-1, 0, 0);
Clazz_defineStatics (c$,
"opPlanes", null);
});
Clazz_declarePackage ("JS");
...
Clazz_declarePackage ("JS");
Clazz_load (["JU.P3", "$.V3"], "JS.SymmetryDesc", ["java.lang.Boolean", "$.Float", "java.util.Hashtable", "JU.BS", "$.Lst", "$.M4", "$.Measure", "$.P4", "$.PT", "$.Quat", "$.SB", "JM.Atom", "JS.T", "JS.SpaceGroup", "$.Symmetry", "$.SymmetryOperation", "JU.Escape", "$.Logger"], function () {
c$ = Clazz_decorateAsClass (function () {
this.modelSet = null;
Clazz_instantialize (this, arguments);
}, JS, "SymmetryDesc");
...
Clazz_defineMethod (c$, "createInfoArray", 
 function (op, uc, ptFrom, ptTarget, id, scaleFactor, options, haveTranslation, bsInfo, isSpaceGroup, isAll) {
if (!op.isFinalized) op.doFinalize ();
...
JS.SymmetryOperation.approxPt (JS.SymmetryDesc.vtrans);
...
margin = (Math.abs (w) < 0.01 && JS.SymmetryDesc.vtemp.x * JS.SymmetryDesc.vtemp.y > 0.4 ? 1.3 : 1.05);
isRotation = false;
haveInversion = false;
isMirrorPlane = true;
break;
...
var fx = Math.abs (JS.SymmetryOperation.approx (ftrans.x));
var fy = Math.abs (JS.SymmetryOperation.approx (ftrans.y));
var fz = Math.abs (JS.SymmetryOperation.approx (ftrans.z));
if (fx != 0 && fy != 0 && fz != 0) {
...
var title = (isSpaceGroup ? "<hover>" + info1 + "</hover>" : null);
if (isRotation) {
color = "red";
ang = ang1;
var scale = 1;
...
}} else if (isSpaceGroup && isAll && pitch1 != 0 && !haveInversion && isccw == null) {
p2 = JU.P3.newP (pa1);
p2.add (JS.SymmetryDesc.vtemp);
ptr.scaleAdd2 (1.5, JS.SymmetryDesc.vtemp, pa1);
uc.toFractional (ptr, false);
if (JS.SymmetryOperation.checkOpPoint (JS.SymmetryOperation.opClean (ptr))) ptr.setT (p2);
 else p2 = null;
} else if (haveInversion && isSpaceGroup && isAll) {
p2 = pt1;
JS.SymmetryDesc.vtemp.scale (-1);
}if (pitch1 > 0) {
wp = "" + (90 - Clazz_floatToInt (JS.SymmetryDesc.vtemp.length () / pitch1 * 90));
...
if (!isSpaceGroup) {
JS.SymmetryDesc.drawVector (draw1, drawid, "invArrow", "vector", "0.05", pta00, JS.SymmetryDesc.ptemp, isTimeReversed ? "gray" : "cyan", null);
}} else {
if (!isSpaceGroup) {
draw1.append (" color cyan");
if (!isSpecial) {
JS.SymmetryDesc.ptemp.sub2 (pt0, ptinv);
JS.SymmetryDesc.drawVector (draw1, drawid, "invArrow", "vector", "0.05", ptinv, JS.SymmetryDesc.ptemp, isTimeReversed ? "gray" : "cyan", null);
}if (options != 1073742066 && !isSpaceGroup) {
...
if (op.number > 0) {
var orig = JS.SymmetryOperation.getMatrixFromXYZ (op.xyzOriginal, false);
orig.sub (m2);
cift =  new JU.P3 ();
...
if (pt2 == null) {
if (xyz == null) {
ops = (isAll ? uc.getAdditionalOperations () : uc.getSymmetryOperations ());
...
}info = this.createInfoArray (opTemp, uc, pt, null, (id == null ? "sym" : id), scaleFactor, options, (translation != null), bsInfo, isSpaceGroup, isAll);
...
uc =  new JS.Symmetry ().setUnitCell (null, false);
