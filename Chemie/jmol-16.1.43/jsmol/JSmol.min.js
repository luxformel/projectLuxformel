(function (a, m) {
  ...
  function l(g) {
    var w = g.length,
      a = f.type(g);
    return "function" === a || f.isWindow(g)
      ? !1
      : 1 === g.nodeType && w
      ? !0
      : "array" === a ||
        0 === w ||
        ("number" === typeof w && 0 < w && w - 1 in g);
  }
  function h(g, a, p) {
    if (f.isFunction(a))
      return f.grep(g, function (g, b) {
        return !!a.call(g, b, g) !== p;
      });
    if (a.nodeType)
    ...
    if ("string" === typeof a) {
      if (Vc.test(a)) return f.filter(a, g, p);
      a = f.filter(a, g);
    }
    return f.grep(g, function (g) {
      return 0 <= f.inArray(g, a) !== p;
    });
  }
  function e(g, a) {
    do g = g[a];
  ...
  function j() {
    y.addEventListener
      ...
      : (y.detachEvent("onreadystatechange", t), a.detachEvent("onload", t));
  }
  function t() {
    if (
      y.addEventListener ||
  ...
  function s(g, a, p) {
    if (void 0 === p && 1 === g.nodeType)
      if (
        ((p = "data-" + a.replace(Wc, "-$1").toLowerCase()),
        (p = g.getAttribute(p)),
        "string" === typeof p)
      ) {
        try {
  ...
  function b(g, a, p, Xa) {
    if (f.acceptData(g)) {
      ...
      if (
        (n && d[n] && (Xa || d[n].data)) ||
        !(void 0 === p && "string" === typeof a)
      ) {
        n || (n = c ? (g[b] = k.pop() || f.guid++) : b);
        d[n] || (d[n] = c ? {} : { toJSON: f.noop });
        if ("object" === typeof a || "function" === typeof a)
          Xa
            ? (d[n] = f.extend(d[n], a))
            : (d[n].data = f.extend(d[n].data, a));
        g = d[n];
        Xa || (g.data || (g.data = {}), (g = g.data));
        void 0 !== p && (g[f.camelCase(a)] = p);
        "string" === typeof a
          ? ((p = g[a]), null == p && (p = g[f.camelCase(a)]))
          : (p = g);
        return p;
      }
    }
  ...
  function c(g, a, p) {
    if (f.acceptData(g)) {
      var b,
        ...
        k = g.nodeType,
        d = k ? f.cache : g,
        n = k ? g[f.expando] : f.expando;
      if (d[n]) {
        if (a && (b = p ? d[n] : d[n].data)) {
          f.isArray(a)
            ? (a = a.concat(f.map(a, f.camelCase)))
            : a in b
            ? (a = [a])
            : ((a = f.camelCase(a)), (a = a in b ? [a] : a.split(" ")));
          for (c = a.length; c--; ) delete b[a[c]];
          if (p ? !u(b) : !f.isEmptyObject(b)) return;
        }
        if (!p && (delete d[n].data, !u(d[n]))) return;
        k
          ? f.cleanData([g], !0)
          : v.deleteExpando || d != d.window
          ? delete d[n]
          : (d[n] = null);
      }
    }
  ...
  function U(g) {
    ...
    if (g.createElement) for (; a.length; ) g.createElement(a.pop());
    return g;
  }
  function C(g, a) {
    var p,
      ...
      c = 0,
      k =
        typeof g.getElementsByTagName !== ka
          ? g.getElementsByTagName(a || "*")
          : typeof g.querySelectorAll !== ka
          ? g.querySelectorAll(a || "*")
          : void 0;
    if (!k) {
      k = [];
      for (p = g.childNodes || g; null != (b = p[c]); c++)
        !a || f.nodeName(b, a) ? k.push(b) : f.merge(k, C(b, a));
    }
    return void 0 === a || (a && f.nodeName(g, a)) ? f.merge([g], k) : k;
  }
  function rb(g) {
    Mb.test(g.type) && (g.defaultChecked = g.checked);
  }
  function Ya(g, a) {
    return f.nodeName(g, "table") &&
      f.nodeName(11 !== a.nodeType ? a : a.firstChild, "tr")
      ? g.getElementsByTagName("tbody")[0] ||
          g.appendChild(g.ownerDocument.createElement("tbody"))
      : g;
  }
  function Ca(g) {
  ...
  function O(g, a) {
    for (var p, b = 0; null != (p = g[b]); b++)
      f._data(p, "globalEval", !a || f._data(a[b], "globalEval"));
  }
  function Da(g, a) {
    if (1 === a.nodeType && f.hasData(g)) {
      ...
      var k = f._data(a, b),
        d = b.events;
      if (d)
        for (p in (delete k.handle, (k.events = {}), d)) {
          b = 0;
          for (c = d[p].length; b < c; b++) f.event.add(a, p, d[p][b]);
        }
      k.data && (k.data = f.extend({}, k.data));
    }
  }
  function Na(g, w) {
    var p = f(w.createElement(g)).appendTo(w.body),
      b = a.getDefaultComputedStyle
        ? a.getDefaultComputedStyle(p[0]).display
        : f.css(p[0], "display");
    p.detach();
    return b;
  }
  function db(g) {
    ...
    if (!p) {
      ...
      if ("none" === p || !p)
        (eb = (
          eb || f("<iframe frameborder='0' width='0' height='0'/>")
  ...
  function gb(g, a) {
    if (a in g) return a;
    for (
      var p = a.charAt(0).toUpperCase() + a.slice(1), b = a, f = oc.length;
      f--;
  ...
  function ta(g, a) {
    for (var p, b, c, k = [], d = 0, n = g.length; d < n; d++)
      if (((b = g[d]), b.style))
        if (((k[d] = f._data(b, "olddisplay")), (p = b.style.display), a))
          !k[d] && "none" === p && (b.style.display = ""),
            "" === b.style.display &&
              hb(b) &&
              (k[d] = f._data(b, "olddisplay", db(b.nodeName)));
        else if (!k[d] && ((c = hb(b)), (p && "none" !== p) || !c))
          f._data(b, "olddisplay", c ? p : f.css(b, "display"));
    for (d = 0; d < n; d++)
      if (
        ((b = g[d]),
        b.style && (!a || "none" === b.style.display || "" === b.style.display))
      )
        b.style.display = a ? k[d] || "" : "none";
    return g;
  }
  function la(g, a, p) {
  ...
  function x(g, a, p, b, c) {
    ...
    for (var k = 0; 4 > a; a += 2)
      "margin" === p && (k += f.css(g, p + Oa[a], !0, c)),
        b
          ? ("content" === p && (k -= f.css(g, "padding" + Oa[a], !0, c)),
            "margin" !== p &&
              (k -= f.css(g, "border" + Oa[a] + "Width", !0, c)))
          : ((k += f.css(g, "padding" + Oa[a], !0, c)),
            "padding" !== p &&
              (k += f.css(g, "border" + Oa[a] + "Width", !0, c)));
    return k;
  }
  function W(g, a, p) {
    var b = !0,
      ...
      k = Pa(g),
      d = v.boxSizing() && "border-box" === f.css(g, "boxSizing", !1, k);
    if (0 >= c || null == c) {
      c = Qa(g, a, k);
      if (0 > c || null == c) c = g.style[a];
      if (sb.test(c)) return c;
      b = d && (v.boxSizingReliable() || c === g.style[a]);
      c = parseFloat(c) || 0;
    }
    return c + x(g, a, p || (d ? "border" : "content"), b, k) + "px";
  }
  function H(g, a, p, b, f) {
    return new H.prototype.init(g, a, p, b, f);
  }
  function ga() {
    setTimeout(function () {
      Za = void 0;
  ...
  function L(g, a) {
    ...
    for (a = a ? 1 : 0; 4 > f; f += 2 - a)
      (p = Oa[f]), (b["margin" + p] = b["padding" + p] = g);
    a && (b.opacity = b.width = g);
    return b;
  }
  function ua(g, a, p) {
    for (
      var b, f = (ib[a] || []).concat(ib["*"]), c = 0, k = f.length;
      c < k;
      c++
    )
  ...
  function jb(g, a, p) {
      ...
      r = n.promise({
        ...
        createTween: function (a, w) {
          var p = f.Tween(
            ...
            a,
            w,
            r.opts.specialEasing[a] || r.opts.easing
          );
          r.tweens.push(p);
          return p;
        },
        stop: function (a) {
          ...
          if (c) return this;
          for (c = !0; w < p; w++) r.tweens[w].run(1);
    ...
    for (b in a)
      if (
        ...
        (q = p[h]),
        (l = a[b]),
        f.isArray(l) && ((q = l[1]), (l = a[b] = l[0])),
        b !== h && ((a[h] = l), delete a[b]),
        (j = f.cssHooks[h]) && "expand" in j)
      )
        for (b in ((l = j.expand(l)), delete a[h], l))
          b in a || ((a[b] = l[b]), (p[b] = q));
      else p[h] = q;
    for (; k < d; k++) if ((b = tb[k].call(r, g, a, r.opts))) return b;
    f.map(a, ua, r);
    f.isFunction(r.opts.start) && r.opts.start.call(g, r);
    f.fx.timer(f.extend(e, { elem: g, anim: r, queue: r.opts.queue }));
    return r
  ...
  function kb(g) {
    return function (a, p) {
      ...
      var b,
        c = 0,
        k = a.toLowerCase().match(va) || [];
      if (f.isFunction(p))
        for (; (b = k[c++]); )
          "+" === b.charAt(0)
            ? ((b = b.slice(1) || "*"), (g[b] = g[b] || []).unshift(p))
            : (g[b] = g[b] || []).push(p);
    };
  }
  function ub(g, a, p, b) {
    function c(n) {
      ...
      f.each(g[n] || [], function (g, f) {
        var n = f(a, p, b);
        if ("string" === typeof n && !d && !k[n])
          return a.dataTypes.unshift(n), c(n), !1;
        if (d) return !(e = n);
      });
      return e;
    }
  ...
  function ma(g, a, p, b) {
    var c;
    if (f.isArray(a))
      f.each(a, function (a, w) {
        p || ad.test(g)
          ? b(g, w)
          : ma(g + "[" + ("object" === typeof w ? a : "") + "]", w, p, b);
      });
    else if (!p && "object" === f.type(a))
      for (c in a) ma(g + "[" + c + "]", a[c], p, b);
    else b(g, a);
  }
  function B(g) {
    try {
      return g
        ? new a.ActiveXObject("Microsoft.XMLHTTP")
      ...
      if (null != (c = arguments[d]))
        for (b in c)
          (g = k[b]),
            (p = c[b]),
            k !== p &&
              (e && p && (f.isPlainObject(p) || (a = f.isArray(p)))
                ? (a
                    ? ((a = !1), (g = g && f.isArray(g) ? g : []))
                    : (g = g && f.isPlainObject(g) ? g : {}),
                  (k[b] = f.extend(e, g, p)))
                : void 0 !== p && (k[b] = p));
    return k;
  };
  f.extend({
    ...
    isPlainObject: function (g) {
      var a;
      if (!g || "object" !== f.type(g) || g.nodeType || f.isWindow(g))
        return !1;
      try {
        if (
          g.constructor &&
          !xa.call(g, "constructor") &&
          !xa.call(g.constructor.prototype, "isPrototypeOf")
        )
          return !1;
      } catch (p) {
        return !1;
      }
      if (v.ownLast) for (a in g) return xa.call(g, a);
      for (a in g);
      return void 0 === a || xa.call(g, a);
    },
    type: function (g) {
      return null == g
        ? g + ""
    ...
    each: function (g, a, p) {
      ...
      b = l(g);
      if (p)
        if (b) for (; f < c && !((b = a.apply(g[f], p)), !1 === b); f++);
        else
          for (f in g) {
      ...
      else for (f in g) if (((b = a.call(g[f], f, g[f])), !1 === b)) break;
      return g;
    },
    trim:
      Ob && !Ob.call("\ufeff\u00a0")
    ...
    merge: function (g, a) {
      ...
      if (p !== p) for (; void 0 !== a[b]; ) g[f++] = a[b++];
      g.length = f;
      return g;
    },
    grep: function (g, a, p) {
      for (var b = [], f = 0, c = g.length, k = !p; f < c; f++)
        (p = !a(g[f], f)), p !== k && b.push(g[f]);
      return b;
    },
    map: function (g, a, p) {
      var b,
        ...
        c = g.length,
        k = [];
      if (l(g)) for (; f < c; f++) (b = a(g[f], f, p)), null != b && k.push(b);
      else for (f in g) (b = a(g[f], f, p)), null != b && k.push(b);
      return r.apply([], k);
    },
    guid: 1,
    proxy: function (g, a) {
  ...
  var Pb = a,
        ...
        if ((f = gd.exec(g)))
          if ((k = f[1]))
            if (9 === d)
              ...
              if (
                a.ownerDocument &&
                (c = a.ownerDocument.getElementById(k)) &&
                ra(a, c) &&
                c.id === k
              )
                return p.push(c), p;
            ...
            if (f[2]) return Ea.apply(p, a.getElementsByTagName(g)), p;
            if (
              (k = f[3]) &&
              G.getElementsByClassName &&
              a.getElementsByClassName
            )
              return Ea.apply(p, a.getElementsByClassName(k)), p;
          }
        if (G.qsa && (!Q || !Q.test(g))) {
          c = f = I;
          k = a;
          ...
          if (n)
            try {
              return Ea.apply(p, k.querySelectorAll(n)), p;
            } catch (e) {
            } finally {
      ...
      a: {
        ...
        if (!b && 1 === c.length) {
          ...
          if (
            ...
            a = (F.find.ID(r.matches[0].replace(Fa, Ga), a) || [])[0];
            if (!a) {
              r = p;
              break a;
            }
          ...
          for (d = xb.needsContext.test(g) ? 0 : f.length; d--; ) {
            r = f[d];
            if (F.relative[(k = r.type)]) break;
            if ((k = F.find[k]))
              if (
                (b = k(
                  r.matches[0].replace(Fa, Ga),
                  (Qb.test(f[0].type) && ha(a.parentNode)) || a
                ))
              ) {
                f.splice(d, 1);
                g = b.length && vb(f);
        ...
        $a(g, c)(b, a, !Z, p, (Qb.test(g) && ha(a.parentNode)) || a);
        r = p;
      }
      return r;
    },
    Rb = function () {
      function g(p, b) {
        a.push(p + " ") > F.cacheLength && delete g[a.shift()];
        return (g[p + " "] = b);
      }
      var a = [];
      return g;
    ...
    Sb = function (g, a) {
      for (var p = g.split("|"), b = g.length; b--; ) F.attrHandle[p[b]] = a;
    },
    pc = function (g, a) {
      var p = a && g,
        b =
          ...
          1 === g.nodeType &&
          1 === a.nodeType &&
          (~a.sourceIndex || S) - (~g.sourceIndex || S);
      if (b) return b;
      if (p) for (; (p = p.nextSibling); ) if (p === a) return -1;
      return g ? 1 : -1;
    },
    id = function (g) {
      return function (a) {
    ...
    Ra = function (g) {
      return R(function (a) {
        a = +a;
        return R(function (p, b) {
          for (var f, c = g([], p.length, a), k = c.length; k--; )
            if (p[(f = c[k])]) p[f] = !(b[f] = p[f]);
        });
      });
    },
    ha = function (g) {
    ...
    sa = function (g, a) {
      var p, b, f, c, k, d, n;
      if ((k = Ha[g + " "])) return a ? 0 : k.slice(0);
      k = g;
      d = [];
      for (n = F.preFilter; k; ) {
        if (!p || (b = kd.exec(k)))
          b && (k = k.slice(b[0].length) || k), d.push((f = []));
        p = !1;
        if ((b = ld.exec(k)))
          (p = b.shift()),
            f.push({ value: p, type: b[0].replace(wb, " ") }),
            (k = k.slice(p.length));
        for (c in F.filter)
          if ((b = xb[c].exec(k)) && (!n[c] || (b = n[c](b))))
            (p = b.shift()),
              f.push({ value: p, type: c, matches: b }),
              (k = k.slice(p.length));
        if (!p) break;
      }
      return a ? k.length : k ? D.error(g) : Ha(g, d).slice(0);
    },
    vb = function (g) {
    ...
    Tb = function (g, a, p) {
      ...
      return a.first
        ? function (a, p, w) {
            for (; (a = a[b]); ) if (1 === a.nodeType || f) return g(a, p, w);
          }
        : function (a, p, w) {
            var k,
              d,
            ...
            if (w)
              for (; (a = a[b]); ) {
                if ((1 === a.nodeType || f) && g(a, p, w)) return !0;
              }
            else
              for (; (a = a[b]); )
                if (1 === a.nodeType || f) {
                  d = a[I] || (a[I] = {});
                  if ((k = d[b]) && k[0] === da && k[1] === c)
                    return (n[2] = k[2]);
                  d[b] = n;
                  if ((n[2] = g(a, p, w))) return !0;
                }
          };
    },
    Ub = function (g) {
      return 1 < g.length
        ? function (a, p, b) {
            for (var f = g.length; f--; ) if (!g[f](a, p, b)) return !1;
            return !0;
          }
        : g[0];
    },
    Sa = function (g, a, p, b, f) {
      for (var c, k = [], d = 0, n = g.length, e = null != a; d < n; d++)
        if ((c = g[d])) if (!p || p(c, b, f)) k.push(c), e && a.push(d);
      return k;
    },
    Vb = function (g, a, p, b, f, c) {
      b && !b[I] && (b = Vb(b));
      f && !f[I] && (f = Vb(f, c));
      return R(function (c, k, d, n) {
        var e,
          r,
          qa = [],
          h = [],
        ...
        if (!(q = c)) {
          q = a || "*";
          for (
            var j = d.nodeType ? [d] : d, A = [], z = 0, T = j.length;
            z < T;
            z++
          )
            D(q, j[z], A);
        ...
        q = g && (c || !a) ? Sa(q, qa, g, d, n) : q;
        j = p ? (f || (c ? g : l || b) ? [] : k) : q;
        p && p(q, j, d, n);
        if (b) {
          e = Sa(j, h);
          b(e, [], d, n);
          for (d = e.length; d--; ) if ((r = e[d])) j[h[d]] = !(q[h[d]] = r);
        }
        if (c) {
          if (f || g) {
            if (f) {
              e = [];
              for (d = j.length; d--; ) if ((r = j[d])) e.push((q[d] = r));
              f(null, (j = []), e, n);
            }
            for (d = j.length; d--; )
              if ((r = j[d]) && -1 < (e = f ? Ta.call(c, r) : qa[d]))
                c[e] = !(k[e] = r);
          }
        } else (j = Sa(j === k ? j.splice(l, j.length) : j)), f ? f(null, k, j, n) : Ea.apply(k, j);
      });
    },
    Wb = function (g) {
      var a,
      ...
      for (
        ...
        if ((p = F.relative[g[k].type])) e = [Tb(Ub(e), p)];
        else {
          p = F.filter[g[k].type].apply(null, g[k].matches);
          if (p[I]) {
            for (b = ++k; b < f && !F.relative[g[b].type]; b++);
            return Vb(
              1 < k && Ub(e),
              1 < k &&
                vb(
  ...
  try {
    Ea.apply((M = tc.call(Y.childNodes)), Y.childNodes),
      M[Y.childNodes.length].nodeType;
  } catch (Zd) {
    Ea = {
      apply: M.length
        ? function (g, a) {
  ...
  rc = D.isXML = function (g) {
    return (g = g && (g.ownerDocument || g).documentElement)
      ? "HTML" !== g.nodeName
      : !1;
  };
  na = D.setDocument = function (g) {
    var a = g ? g.ownerDocument || g : Y;
    g = a.defaultView;
    if (a === P || 9 !== a.nodeType || !a.documentElement) return P;
    P = a;
    ia = a.documentElement;
    Z = !rc(a);
    g &&
      g !== g.top &&
      (g.addEventListener
    ...
    G.attributes = oa(function (g) {
      g.className = "i";
      return !g.getAttribute("className");
    });
    G.getElementsByTagName = oa(function (g) {
      g.appendChild(a.createComment(""));
      return !g.getElementsByTagName("*").length;
    });
    G.getElementsByClassName =
      lb.test(a.getElementsByClassName) &&
      oa(function (g) {
        g.innerHTML = "<div class='a'></div><div class='a i'></div>";
        g.firstChild.className = "i";
        return 2 === g.getElementsByClassName("i").length;
      });
    G.getById = oa(function (g) {
      ia.appendChild(g).id = I;
      return !a.getElementsByName || !a.getElementsByName(I).length;
    });
    G.getById
      ? ((F.find.ID = function (g, a) {
          if (typeof a.getElementById !== T && Z) {
            var b = a.getElementById(g);
            return b && b.parentNode ? [b] : [];
          }
        }),
        (F.filter.ID = function (g) {
          var a = g.replace(Fa, Ga);
          return function (g) {
      ...
      : (delete F.find.ID,
        (F.filter.ID = function (g) {
          ...
          return function (g) {
            return (
              (g =
                typeof g.getAttributeNode !== T && g.getAttributeNode("id")) &&
              g.value === a
            );
          };
        }));
    F.find.TAG = G.getElementsByTagName
      ? function (g, a) {
          if (typeof a.getElementsByTagName !== T)
      ...
      : function (g, a) {
          ...
          if ("*" === g) {
            for (; (b = c[f++]); ) 1 === b.nodeType && w.push(b);
            return w;
          }
          return c;
        };
    F.find.CLASS =
      G.getElementsByClassName &&
      function (g, a) {
        if (typeof a.getElementsByClassName !== T && Z)
          return a.getElementsByClassName(g);
      };
    ea = [];
    Q = [];
    if ((G.qsa = lb.test(a.querySelectorAll)))
      oa(function (g) {
        g.innerHTML = "<select t=''><option selected=''></option></select>";
        g.querySelectorAll("[t^='']").length &&
          Q.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:''|\"\")");
        ...
        oa(function (g) {
          ...
          g.querySelectorAll("[name=d]").length &&
            Q.push("name[\\x20\\t\\r\\n\\f]*[*^$|!~]?=");
          g.querySelectorAll(":enabled").length ||
            Q.push(":enabled", ":disabled");
          g.querySelectorAll("*,:x");
          Q.push(",.*:");
        });
    (G.matchesSelector = lb.test(
      (Ja =
        ia.webkitMatchesSelector ||
        ia.mozMatchesSelector ||
        ia.oMatchesSelector ||
        ia.msMatchesSelector)
    )) &&
      oa(function (g) {
        G.disconnectedMatch = Ja.call(g, "div");
        Ja.call(g, "[s!='']:x");
        ea.push("!=", Xb);
      });
    ...
    ra =
      (g = lb.test(ia.compareDocumentPosition)) || lb.test(ia.contains)
        ? function (g, a) {
                ...
                !(
                  ...
                  (b.contains
                    ...
                    : g.compareDocumentPosition &&
                      g.compareDocumentPosition(w) & 16)
                )
              )
            );
          }
        : function (g, a) {
            if (a) for (; (a = a.parentNode); ) if (a === g) return !0;
            return !1;
          };
    A = g
      ? function (g, b) {
          if (g === b) return (Aa = !0), 0;
          var f = !g.compareDocumentPosition - !b.compareDocumentPosition;
          if (f) return f;
          f =
            (g.ownerDocument || g) === (b.ownerDocument || b)
              ? g.compareDocumentPosition(b)
              : 1;
          return f & 1 ||
            (!G.sortDetached && b.compareDocumentPosition(g) === f)
            ? g === a || (g.ownerDocument === Y && ra(Y, g))
              ? -1
              : b === a || (b.ownerDocument === Y && ra(Y, b))
              ? 1
              : pa
              ? Ta.call(pa, g) - Ta.call(pa, b)
              : 0
            : f & 4
            ? -1
            : 1;
      ...
      : function (g, b) {
          ...
          for (; d[c] === n[c]; ) c++;
          return c ? pc(d[c], n[c]) : d[c] === Y ? -1 : n[c] === Y ? 1 : 0;
        };
    return a;
  };
  ...
  D.matchesSelector = function (g, a) {
    (g.ownerDocument || g) !== P && na(g);
    a = a.replace(od, "='$1']");
    if (G.matchesSelector && Z && (!ea || !ea.test(a)) && (!Q || !Q.test(a)))
      try {
        var b = Ja.call(g, a);
        if (
          b ||
          G.disconnectedMatch ||
          (g.document && 11 !== g.document.nodeType)
        )
          return b;
      } catch (f) {}
    return 0 < D(a, P, null, [g]).length;
  };
  ...
  D.attr = function (g, a) {
    (g.ownerDocument || g) !== P && na(g);
    var b = F.attrHandle[a.toLowerCase()],
      b = b && fa.call(F.attrHandle, a.toLowerCase()) ? b(g, a, !Z) : void 0;
    return void 0 !== b
      ? b
      : G.attributes || !Z
      ? g.getAttribute(a)
      : (b = g.getAttributeNode(a)) && b.specified
      ? b.value
      : null;
  };
  D.error = function (g) {
  ...
  D.uniqueSort = function (g) {
    var a,
      ...
      f = 0,
      c = 0;
    Aa = !G.detectDuplicates;
    pa = !G.sortStable && g.slice(0);
    g.sort(A);
    if (Aa) {
  ...
  Ia = D.getText = function (g) {
    ...
    if ((a = g.nodeType))
      if (1 === a || 9 === a || 11 === a) {
        ...
        for (g = g.firstChild; g; g = g.nextSibling) b += Ia(g);
      } else {
        if (3 === a || 4 === a) return g.nodeValue;
      }
    else for (; (a = g[f++]); ) b += Ia(a);
    return b;
  };
  F = D.selectors = {
    cacheLength: 50,
    ...
    preFilter: {
      ATTR: function (g) {
        g[1] = g[1].replace(Fa, Ga);
        g[3] = (g[4] || g[5] || "").replace(Fa, Ga);
        "~=" === g[2] && (g[3] = " " + g[3] + " ");
        return g.slice(0, 4);
      },
      CHILD: function (g) {
      ...
      PSEUDO: function (g) {
        ...
        if (g[3] && void 0 !== g[4]) g[2] = g[4];
          ...
          pd.test(b) &&
          (a = sa(b, !0)) &&
          (a = b.indexOf(")", b.length - a) - b.length)
        )
          (g[0] = g[0].slice(0, a)), (g[2] = b.slice(0, a));
        return g.slice(0, 3);
      },
    },
    filter: {
      TAG: function (g) {
        var a = g.replace(Fa, Ga).toLowerCase();
        return "*" === g
          ? function () {
              return !0;
            }
            ...
            sc(g, function (g) {
              return a.test(
                ("string" === typeof g.className && g.className) ||
                  (typeof g.getAttribute !== T && g.getAttribute("class")) ||
                  ""
              );
            }))
        );
      ...
      ATTR: function (g, a, b) {
        return function (f) {
          ...
          return "=" === a
            ...
            ? b && -1 < f.indexOf(b)
            : "$=" === a
            ? b && f.slice(-b.length) === b
            : "~=" === a
            ? -1 < (" " + f + " ").indexOf(b)
            : "|=" === a
            ? f === b || f.slice(0, b.length + 1) === b + "-"
            : !1;
        };
      },
          ...
          : function (a, b, p) {
              ...
              if (j) {
                if (k) {
                  for (; b; ) {
                    for (e = a; (e = e[b]); )
                      if (n ? e.nodeName.toLowerCase() === l : 1 === e.nodeType)
                        return !1;
                ...
                } else if (p && (w = (a[I] || (a[I] = {}))[g]) && w[0] === da)
                  r = w[1];
                else
                  for (; (e = (++h && e && e[b]) || (r = h = 0) || q.pop()); )
                    if (
                      (n ? e.nodeName.toLowerCase() === l : 1 === e.nodeType) &&
                      ++r
                    )
                      if ((p && ((e[I] || (e[I] = {}))[g] = [da, r]), e === a))
                        break;
                r -= c;
      ...
      PSEUDO: function (g, a) {
        var b,
          f =
            F.pseudos[g] ||
            F.setFilters[g.toLowerCase()] ||
            D.error("unsupported pseudo: " + g);
        return f[I]
          ? f(a)
          : 1 < f.length
          ? ((b = [g, g, "", a]),
            F.setFilters.hasOwnProperty(g.toLowerCase())
              ? R(function (g, b) {
                  for (var p, c = f(g, a), k = c.length; k--; )
                    (p = Ta.call(g, c[k])), (g[p] = !(b[p] = c[k]));
                })
              : function (g) {
                  return f(g, 0, b);
                })
    ...
    pseudos: {
      not: R(function (g) {
        ...
        return f[I]
          ? R(function (g, a, b, p) {
              p = f(g, null, p, []);
              for (var w = g.length; w--; ) if ((b = p[w])) g[w] = !(a[w] = b);
            })
          : function (g, c, k) {
              a[0] = g;
              f(a, null, k, b);
      ...
      contains: R(function (g) {
        return function (a) {
          return -1 < (a.textContent || a.innerText || Ia(a)).indexOf(g);
        };
      }),
      lang: R(function (g) {
        qd.test(g || "") || D.error("unsupported lang: " + g);
        g = g.replace(Fa, Ga).toLowerCase();
        return function (a) {
          var b;
          do
            if (
              ...
              return (b = b.toLowerCase()), b === g || 0 === b.indexOf(g + "-");
      ...
      checked: function (g) {
        ...
        return (
          ("input" === a && !!g.checked) || ("option" === a && !!g.selected)
        );
      },
      selected: function (g) {
      ...
      button: function (g) {
        var a = g.nodeName.toLowerCase();
        return ("input" === a && "button" === g.type) || "button" === a;
      },
      text: function (g) {
        var a;
        return (
          "input" === g.nodeName.toLowerCase() &&
          "text" === g.type &&
          (null == (a = g.getAttribute("type")) || "text" === a.toLowerCase())
        );
      },
      first: Ra(function () {
        return [0];
      }),
      last: Ra(function (g, a) {
        return [a - 1];
      }),
      eq: Ra(function (g, a, b) {
        return [0 > b ? b + a : b];
      }),
      even: Ra(function (g, a) {
      ...
      lt: Ra(function (g, a, b) {
        for (a = 0 > b ? b + a : b; 0 <= --a; ) g.push(a);
        return g;
      }),
      gt: Ra(function (g, a, b) {
  ...
  for (za in { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 })
    F.pseudos[za] = id(za);
  for (za in { submit: !0, reset: !0 }) F.pseudos[za] = jd(za);
  qc.prototype = F.filters = F.pseudos;
  F.setFilters = new qc();
  $a = D.compile = function (g, a) {
    ...
    if (!k) {
      a || (a = sa(g));
      for (b = a.length; b--; ) (k = Wb(a[b])), k[I] ? f.push(k) : c.push(k);
      var d = 0 < f.length,
        n = 0 < c.length;
      b = function (g, a, b, p, w) {
        var k,
          e,
          r,
          h = 0,
          ...
          l = ya,
          A = g || (n && F.find.TAG("*", w)),
          z = (da += null == l ? 1 : Math.random() || 0.1),
          T = A.length;
        for (w && (ya = a !== P && a); q !== T && null != (k = A[q]); q++) {
          if (n && k) {
            for (e = 0; (r = c[e++]); )
              if (r(k, a, b)) {
                p.push(k);
        ...
        h += q;
        if (d && q !== h) {
          for (e = 0; (r = f[e++]); ) r(j, qa, a, b);
          if (g) {
            if (0 < h) for (; q--; ) !j[q] && !qa[q] && (qa[q] = aa.call(p));
            qa = Sa(qa);
          }
          Ea.apply(p, qa);
          w && !g && 0 < qa.length && 1 < h + f.length && D.uniqueSort(p);
        }
        w && ((da = z), (ya = l));
        return j;
      };
  ...
  G.sortStable = I.split("").sort(A).join("") === I;
  G.detectDuplicates = !!Aa;
  na();
  G.sortDetached = oa(function (g) {
    return g.compareDocumentPosition(P.createElement("div")) & 1;
  });
  oa(function (g) {
    ...
    Sb(
      ...
      function (g, a, b) {
        ...
        if (!b)
          return !0 === g[a]
            ? a.toLowerCase()
            : (f = g.getAttributeNode(a)) && f.specified
            ? f.value
            : null;
      }
    );
  ...
  f.filter = function (g, a, b) {
    var c = a[0];
    b && (g = ":not(" + g + ")");
    return 1 === a.length && 1 === c.nodeType
      ? f.find.matchesSelector(c, g)
        ? [c]
        : []
      : f.find.matches(
          g,
  ...
  f.fn.extend({
    find: function (g) {
      ...
      if ("string" !== typeof g)
        return this.pushStack(
          f(g).filter(function () {
            for (a = 0; a < k; a++) if (f.contains(c[a], this)) return !0;
          })
        );
      for (a = 0; a < k; a++) f.find(g, c[a], b);
      b = this.pushStack(1 < k ? f.unique(b) : b);
      b.selector = this.selector ? this.selector + " " + g : g;
      return b;
    },
    filter: function (g) {
    ...
    is: function (g) {
      return !!h(this, "string" === typeof g && wc.test(g) ? f(g) : g || [], !1)
        .length;
    },
  });
  var mb,
  ...
  (f.fn.init = function (g, a) {
    ...
    if ("string" === typeof g) {
      if (
        (b =
          "<" === g.charAt(0) && ">" === g.charAt(g.length - 1) && 3 <= g.length
            ? [null, g, null]
            : td.exec(g)) &&
        (b[1] || !a)
      ) {
        if (b[1]) {
          if (
            ...
            f.merge(
              this,
              f.parseHTML(b[1], a && a.nodeType ? a.ownerDocument || a : y, !0)
            ),
            xc.test(b[1]) && f.isPlainObject(a))
          )
            for (b in a)
    ...
    if (f.isFunction(g))
      return "undefined" !== typeof mb.ready ? mb.ready(g) : g(f);
    void 0 !== g.selector &&
      ((this.selector = g.selector), (this.context = g.context));
    return f.makeArray(g, this);
  }).prototype = f.fn;
  mb = f(y);
  var ud = /^(?:parents|prev(?:Until|All))/,
    vd = { children: !0, contents: !0, next: !0, prev: !0 };
  f.extend({
    dir: function (g, a, b) {
      var c = [];
      for (
        ...
        g &&
        9 !== g.nodeType &&
        (void 0 === b || 1 !== g.nodeType || !f(g).is(b));

      )
        1 === g.nodeType && c.push(g), (g = g[a]);
      return c;
    },
    sibling: function (g, a) {
      for (var b = []; g; g = g.nextSibling)
        1 === g.nodeType && g !== a && b.push(g);
      return b;
    },
  });
  f.fn.extend({
    has: function (g) {
      ...
      return this.filter(function () {
        for (a = 0; a < c; a++) if (f.contains(this, b[a])) return !0;
      });
    },
    closest: function (g, a) {
      for (
        var b,
          ...
          k = this.length,
          d = [],
          n = wc.test(g) || "string" !== typeof g ? f(g, a || this.context) : 0;
        c < k;
        c++
      )
        for (b = this[c]; b && b !== a; b = b.parentNode)
          if (
            ...
            (n
              ? -1 < n.index(b)
              : 1 === b.nodeType && f.find.matchesSelector(b, g))
          ) {
            d.push(b);
            break;
          }
    ...
    index: function (g) {
      return !g
        ? this[0] && this[0].parentNode
          ...
          : -1
        : "string" === typeof g
        ? f.inArray(this[0], f(g))
        : f.inArray(g.jquery ? g[0] : g, this);
    },
    add: function (g, a) {
  ...
  f.each(
    {
      ...
      contents: function (g) {
        return f.nodeName(g, "iframe")
          ? g.contentDocument || g.contentWindow.document
          : f.merge([], g.childNodes);
      },
    },
    function (g, a) {
      f.fn[g] = function (b, c) {
        ...
        1 < this.length &&
          (vd[g] || (k = f.unique(k)), ud.test(g) && (k = k.reverse()));
  ...
  f.Callbacks = function (g) {
    ...
    if ("string" === typeof g) {
      if (!(a = yc[g])) {
        a = g;
        var b = (yc[a] = {});
        f.each(a.match(va) || [], function (g, a) {
          b[a] = !0;
        });
        a = b;
      }
    ...
    var c,
      ...
      j = function (a) {
        ...
        n = h.length;
        for (c = !0; h && e < n; e++)
          if (!1 === h[e].apply(a[0], a[1]) && g.stopOnFalse) {
            k = !1;
            break;
          }
        c = !1;
      ...
      l = {
          ...
          if (h) {
            ...
            (function $c(a) {
              f.each(a, function (a, b) {
                var p = f.type(b);
                "function" === p
                  ? (!g.unique || !l.has(b)) && h.push(b)
                  : b && b.length && "string" !== p && $c(b);
              });
            })(arguments);
        ...
        remove: function () {
          h &&
            f.each(arguments, function (g, a) {
              for (var b; -1 < (b = f.inArray(a, h, b)); )
                h.splice(b, 1), c && (b <= n && n--, b <= e && e--);
            });
          return this;
        },
        has: function (g) {
          return g ? -1 < f.inArray(g, h) : !(!h || !h.length);
        },
        empty: function () {
          h = [];
          n = 0;
            ...
            return f
              .Deferred(function (b) {
                f.each(a, function (a, p) {
                  var w = f.isFunction(g[a]) && g[a];
                  k[p[1]](function () {
                    var g = w && w.apply(this, arguments);
  ...
  f.extend({
    ...
    ready: function (g) {
      if (!(!0 === g ? --f.readyWait : f.isReady)) {
        if (!y.body) return setTimeout(f.ready);
        f.isReady = !0;
        (!0 !== g && 0 < --f.readyWait) ||
          (yb.resolveWith(y, [f]),
          f.fn.trigger && f(y).trigger("ready").off("ready"));
      }
    },
  });
  f.ready.promise = function (g) {
    if (!yb)
      if (((yb = f.Deferred()), "complete" === y.readyState))
        setTimeout(f.ready);
  ...
  f(function () {
    ...
    if (b) {
      ...
      if (
        typeof a.style.zoom !== ka &&
        ((a.style.cssText =
          "border:0;margin:0;width:1px;padding:1px;display:inline;zoom:1"),
        (v.inlineBlockNeedsLayout = 3 === a.offsetWidth))
      )
        b.style.zoom = 1;
      b.removeChild(g);
    }
  ...
  f.acceptData = function (g) {
    ...
    return 1 !== b && 9 !== b
      ? !1
      : !a || (!0 !== a && g.getAttribute("classid") === a);
  };
  var Xc = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,
    Wc = /([A-Z])/g;
  f.extend({
  ...
  f.fn.extend({
    data: function (g, a) {
      ...
      if (void 0 === g) {
        if (
          this.length &&
          ((k = f.data(d)), 1 === d.nodeType && !f._data(d, "parsedAttrs"))
        ) {
          for (b = n.length; b--; )
            (c = n[b].name),
              0 === c.indexOf("data-") &&
                ((c = f.camelCase(c.slice(5))), s(d, c, k[c]));
  ...
  f.extend({
    ...
    dequeue: function (g, a) {
      ...
      k &&
        ("fx" === a && b.unshift("inprogress"), delete d.stop, k.call(g, n, d));
      !c && d && d.empty.fire();
    },
  ...
  f.fn.extend({
    ...
    promise: function (a, b) {
      ...
      for (a = a || "fx"; e--; )
        if ((c = f._data(n[e], a + "queueHooks")) && c.empty)
          k++, c.empty.add(r);
      r();
      return d.promise(b);
    },
  ...
  var zb = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
    ...
    Ua = (f.access = function (a, b, c, k, d, n, e) {
      var r = 0,
        h = a.length,
        q = null == c;
      if ("object" === f.type(c))
        ...
        for (; r < h; r++) b(a[r], c, e ? k : k.call(a[r], r, b(a[r], c)));
  ...
  ba.innerHTML = "  <link/><table></table><a href='/a'>a</a>";
  v.leadingWhitespace = 3 === ba.firstChild.nodeType;
  v.tbody = !ba.getElementsByTagName("tbody").length;
  v.htmlSerialize = !!ba.getElementsByTagName("link").length;
  v.html5Clone =
    "<:nav></:nav>" !== y.createElement("nav").cloneNode(!0).outerHTML;
  nb.type = "checkbox";
  nb.checked = !0;
  Yb.appendChild(nb);
  v.appendChecked = nb.checked;
  ba.innerHTML = "<textarea>x</textarea>";
  v.noCloneChecked = !!ba.cloneNode(!0).lastChild.defaultValue;
  Yb.appendChild(ba);
  ba.innerHTML = "<input type='radio' checked='checked' name='t'/>";
  v.checkClone = ba.cloneNode(!0).cloneNode(!0).lastChild.checked;
  v.noCloneEvent = !0;
  ba.attachEvent &&
    (ba.attachEvent("onclick", function () {
      v.noCloneEvent = !1;
    }),
    ba.cloneNode(!0).click());
  if (null == v.deleteExpando) {
    v.deleteExpando = !0;
    try {
      delete ba.test;
  ...
  var Yb = (ba = nb = null),
    Ab,
    Bb,
    Ac = y.createElement("div");
  for (Ab in { submit: !0, change: !0, focusin: !0 })
    if (((Bb = "on" + Ab), !(v[Ab + "Bubbles"] = Bb in a)))
      Ac.setAttribute(Bb, "t"),
        (v[Ab + "Bubbles"] = !1 === Ac.attributes[Bb].expando);
  ...
  f.event = {
    ...
    add: function (a, b, c, k, d) {
      ...
      if ((r = f._data(a))) {
        ...
        if (!(e = r.events)) e = r.events = {};
        if (!(q = r.handle))
          (q = r.handle =
            function (a) {
              return typeof f !== ka && (!a || f.event.triggered !== a.type)
          ...
          if (
            ...
            if (!(l = e[A]))
              if (
                ((l = e[A] = []),
                (l.delegateCount = 0),
                !n.setup || !1 === n.setup.call(a, k, z, q))
              )
                a.addEventListener
                  ? a.addEventListener(A, q, !1)
                  : a.attachEvent && a.attachEvent("on" + A, q);
            n.add &&
              (n.add.call(a, j), j.handler.guid || (j.handler.guid = c.guid));
          ...
          if (
            ...
            for (h = n = A.length; n--; )
              if (
                ...
                (d || t === e.origType) &&
                  (!c || c.guid === e.guid) &&
                  (!r || r.test(e.namespace)) &&
                  (!k || k === e.selector || ("**" === k && e.selector)))
              )
                A.splice(n, 1),
                  e.selector && A.delegateCount--,
                  l.remove && l.remove.call(a, e);
            h &&
              !A.length &&
              ((!l.teardown || !1 === l.teardown.call(a, T, K.handle)) &&
                f.removeEvent(a, z, K.handle),
              delete j[z]);
          } else for (z in j) f.event.remove(a, z + b[q], c, k, !0);
        f.isEmptyObject(j) && (delete K.handle, f._removeData(a, "events"));
      }
    },
    trigger: function (g, b, c, k) {
      var d,
        ...
        q,
        j = [c || y],
        l = xa.call(g, "type") ? g.type : g;
      h = xa.call(g, "namespace") ? g.namespace.split(".") : [];
      e = d = c = c || y;
      if (
        !(3 === c.nodeType || 8 === c.nodeType) &&
        !Bc.test(l + f.event.triggered)
      )
        if (
          (0 <= l.indexOf(".") &&
            ((h = l.split(".")), (l = h.shift()), h.sort()),
          (n = 0 > l.indexOf(":") && "on" + l),
          (g = g[f.expando] ? g : new f.Event(l, "object" === typeof g && g)),
          (g.isTrigger = k ? 2 : 3),
          (g.namespace = h.join(".")),
          ...
          (g.result = void 0),
          g.target || (g.target = c),
          (b = null == b ? [g] : f.makeArray(b, [g])),
          (h = f.event.special[l] || {}),
          k || !(h.trigger && !1 === h.trigger.apply(c, b)))
        ) {
          if (!k && !h.noBubble && !f.isWindow(c)) {
            r = h.delegateType || l;
            Bc.test(r + l) || (e = e.parentNode);
            for (; e; e = e.parentNode) j.push(e), (d = e);
            if (d === (c.ownerDocument || y))
              j.push(d.defaultView || d.parentWindow || a);
          }
          for (q = 0; (e = j[q++]) && !g.isPropagationStopped(); )
            if (
              ((g.type = 1 < q ? r : h.bindType || l),
              (d =
                (f._data(e, "events") || {})[g.type] && f._data(e, "handle")) &&
                d.apply(e, b),
              (d = n && e[n]) && d.apply && f.acceptData(e))
            )
              (g.result = d.apply(e, b)), !1 === g.result && g.preventDefault();
          g.type = l;
          if (
            !k &&
            !g.isDefaultPrevented() &&
            (!h._default || !1 === h._default.apply(j.pop(), b)) &&
            f.acceptData(c) &&
            n &&
            c[l] &&
            !f.isWindow(c)
    ...
    dispatch: function (a) {
      ...
      if (!(h.preDispatch && !1 === h.preDispatch.call(this, a))) {
        ...
        for (b = 0; (k = e[b++]) && !a.isPropagationStopped(); ) {
            ...
            for (n = 0; n < r; n++)
              (k = b[n]),
                ...
                void 0 === d[c] &&
                  (d[c] = k.needsContext
                    ? 0 <= f(c, this).index(h)
                    : f.find(c, this, null, [h]).length),
                d[c] && d.push(k);
            d.length && e.push({ elem: h, handlers: d });
          }
      r < b.length && e.push({ elem: this, handlers: b.slice(r) });
      return e;
    },
    fix: function (a) {
      ...
      n ||
        (this.fixHooks[b] = n =
          yd.test(b) ? this.mouseHooks : xd.test(b) ? this.keyHooks : {});
    ...
    mouseHooks: {
      ...
      filter: function (a, b) {
        ...
        null == a.pageX &&
          null != b.clientX &&
          ((f = a.target.ownerDocument || y),
          (c = f.documentElement),
          (f = f.body),
          (a.pageX =
            b.clientX +
            ((c && c.scrollLeft) || (f && f.scrollLeft) || 0) -
            ((c && c.clientLeft) || (f && f.clientLeft) || 0)),
          (a.pageY =
            b.clientY +
            ((c && c.scrollTop) || (f && f.scrollTop) || 0) -
            ((c && c.clientTop) || (f && f.clientTop) || 0)));
        !a.relatedTarget &&
          d &&
          (a.relatedTarget = d === a.target ? b.toElement : d);
        !a.which &&
          void 0 !== k &&
  ...
  f.removeEvent = y.removeEventListener
    ? function (a, b, f) {
    ...
    : function (a, b, f) {
        b = "on" + b;
        a.detachEvent &&
          (typeof a[b] === ka && (a[b] = null), a.detachEvent(b, f));
      };
    ...
    f.event.special[a] = {
      ...
      handle: function (a) {
        ...
        if (!c || (c !== this && !f.contains(this, c)))
          (a.type = k.origType),
            (g = k.handler.apply(this, arguments)),
            (a.type = b);
        return g;
      },
    };
    ...
    (f.event.special.submit = {
      setup: function () {
        ...
        f.event.add(this, "click._submit keypress._submit", function (a) {
          ...
          if (
            (a =
              f.nodeName(a, "input") || f.nodeName(a, "button")
                ? a.form
                : void 0) &&
            !f._data(a, "submitBubbles")
          )
            f.event.add(a, "submit._submit", function (a) {
              a._submit_bubble = !0;
            }),
    ...
    (f.event.special.change = {
      setup: function () {
        ...
        f.event.add(this, "beforeactivate._change", function (a) {
          a = a.target;
          Zb.test(a.nodeName) &&
            !f._data(a, "changeBubbles") &&
            (f.event.add(a, "change._change", function (a) {
              this.parentNode &&
                !a.isSimulated &&
                !a.isTrigger &&
    ...
    f.each({ focus: "focusin", blur: "focusout" }, function (a, b) {
      ...
      f.event.special[b] = {
        ...
        teardown: function () {
          ...
          d
            ? f._data(k, b, d)
            : (k.removeEventListener(a, c, !0), f._removeData(k, b));
        },
      };
    });
  f.fn.extend({
      ...
      if (a && a.preventDefault && a.handleObj)
        return (
          ...
          f(a.delegateTarget).off(
            k.namespace ? k.origType + "." + k.namespace : k.origType,
            k.selector,
            k.handler
          ),
          this
  ...
  var mc =
    ...
    ac = U(y).appendChild(y.createElement("div"));
  ...
  f.extend({
    clone: function (a, b, c) {
      var k,
        ...
        e,
        r,
        h = f.contains(a.ownerDocument, a);
      v.html5Clone || f.isXMLDoc(a) || !Dc.test("<" + a.nodeName + ">")
        ? (n = a.cloneNode(!0))
        : ((ac.innerHTML = a.outerHTML), ac.removeChild((n = ac.firstChild)));
      if (
        ...
        for (e = 0; null != (d = r[e]); ++e)
          if (k[e]) {
            ...
            if (1 === q.nodeType) {
              ...
              if (!v.noCloneEvent && q[f.expando]) {
                A = f._data(q);
                for (j in A.events) f.removeEvent(q, j, A.handle);
                q.removeAttribute(f.expando);
              }
              if ("script" === l && q.text !== d.text)
                (Ca(q).text = d.text), V(q);
              else if ("object" === l)
                q.parentNode && (q.outerHTML = d.outerHTML),
                  v.html5Clone &&
                    d.innerHTML &&
                    !f.trim(q.innerHTML) &&
                    (q.innerHTML = d.innerHTML);
              else if ("input" === l && Mb.test(d.type))
                (q.defaultChecked = q.checked = d.checked),
                  q.value !== d.value && (q.value = d.value);
              else if ("option" === l)
                q.defaultSelected = q.selected = d.defaultSelected;
      ...
      if (b)
        if (c) {
          r = r || C(a);
          k = k || C(n);
          for (e = 0; null != (d = r[e]); e++) Da(d, k[e]);
        } else Da(a, n);
      k = C(n, "script");
      0 < k.length && O(k, !h && C(a, "script"));
      return n;
    },
    buildFragment: function (a, b, c, k) {
      for (
        var d, n, e, r, h, q, l = a.length, j = U(b), A = [], z = 0;
        z < l;
        z++
      )
        if ((n = a[z]) || 0 === n)
          if ("object" === f.type(n)) f.merge(A, n.nodeType ? [n] : n);
            ...
            !v.leadingWhitespace &&
              $b.test(n) &&
              A.push(b.createTextNode($b.exec(n)[0]));
            if (!v.tbody)
              for (
                d =
                  (n =
                ...
                f.nodeName((h = n.childNodes[d]), "tbody") &&
                  !h.childNodes.length &&
                  n.removeChild(h);
      ...
      e && j.removeChild(e);
      v.appendChecked || f.grep(C(A, "input"), rb);
      for (z = 0; (n = A[z++]); )
        if (
          !(k && -1 !== f.inArray(n, k)) &&
          ((a = f.contains(n.ownerDocument, n)),
          (e = C(j.appendChild(n), "script")),
          a && O(e),
          c)
        )
      ...
      for (
        ...
        if (b || f.acceptData(c))
          if ((e = (n = c[h]) && q[n])) {
            if (e.events)
              for (d in e.events)
                j[d] ? f.event.remove(c, d) : f.removeEvent(c, d, e.handle);
            q[n] &&
              (delete q[n],
              l
                ? delete c[h]
                : typeof c.removeAttribute !== ka
                ? c.removeAttribute(h)
                : (c[h] = null),
              k.push(n));
          }
  ...
  f.fn.extend({
    ...
    remove: function (a, b) {
      for (
        var c, k = a ? f.filter(a, this) : this, d = 0;
        null != (c = k[d]);
        d++
      )
        !b && 1 === c.nodeType && f.cleanData(C(c)),
          c.parentNode &&
            (b && f.contains(c.ownerDocument, c) && O(C(c, "script")),
            c.parentNode.removeChild(c));
      return this;
    },
    empty: function () {
      for (var a, b = 0; null != (a = this[b]); b++) {
        for (1 === a.nodeType && f.cleanData(C(a, !1)); a.firstChild; )
      ...
      return Ua(
        ...
        function (a) {
          var g = this[0] || {},
            ...
            c = this.length;
          if (void 0 === a)
            return 1 === g.nodeType ? g.innerHTML.replace(zd, "") : void 0;
          if (
            "string" === typeof a &&
            !Bd.test(a) &&
            (v.htmlSerialize || !Dc.test(a)) &&
            (v.leadingWhitespace || !$b.test(a)) &&
            !ja[(Fc.exec(a) || ["", ""])[1].toLowerCase()]
          ) {
            a = a.replace(Ec, "<$1></$2>");
            try {
              for (; b < c; b++)
                (g = this[b] || {}),
                  1 === g.nodeType &&
                    (f.cleanData(C(g, !1)), (g.innerHTML = a));
              g = 0;
            } catch (k) {}
          }
    ...
    domManip: function (a, b) {
      ...
      var c,
        ...
        j = a[0],
        A = f.isFunction(j);
      if (A || (1 < h && "string" === typeof j && !v.checkClone && Cd.test(j)))
      ...
      if (
        h &&
        ((n = f.buildFragment(a, this[0].ownerDocument, !1, this)),
        (c = n.firstChild),
        1 === n.childNodes.length && (n = c),
        c)
      ) {
        d = f.map(C(n, "script"), Ca);
        for (k = d.length; e < h; e++)
          (c = n),
            e !== l &&
              ((c = f.clone(c, !0, !0)), k && f.merge(d, C(c, "script"))),
            b.call(this[e], c, e);
        if (k) {
  ...
  f.each(
    ...
    function (a, b) {
      f.fn[a] = function (a) {
        for (var g = 0, c = [], k = f(a), d = k.length - 1; g <= d; g++)
          (a = g === d ? this : this.clone(!0)),
            f(k[g])[b](a),
            z.apply(c, a.get());
    ...
    ? ((Pa = function (a) {
      ...
      (Qa = function (a, b, c) {
        var k,
          d,
          n = a.style;
        d = (c = c || Pa(a)) ? c.getPropertyValue(b) || c[b] : void 0;
        c &&
          ("" === d && !f.contains(a.ownerDocument, a) && (d = f.style(a, b)),
          sb.test(d) &&
            Ic.test(b) &&
            ((a = n.width),
            (b = n.minWidth),
    ...
    : y.documentElement.currentStyle &&
      ...
      (Qa = function (a, b, c) {
        var f,
          ...
          d,
          n = a.style;
        d = (c = c || Pa(a)) ? c[b] : void 0;
        null == d && n && n[b] && (d = n[b]);
        if (sb.test(d) && !Ed.test(b)) {
          c = n.left;
          if ((k = (f = a.runtimeStyle) && f.left))
  ...
  var dc = function () {
      ...
      c &&
        ...
        f.swap(c, null != c.style.zoom ? { zoom: 1 } : {}, function () {
          cc = 4 === b.offsetWidth;
        }),
        (Db = !0),
        (Eb = !1),
        (Fb = !0),
        a.getComputedStyle &&
          ((Eb = "1%" !== (a.getComputedStyle(b, null) || {}).top),
          (Db =
            "4px" === (a.getComputedStyle(b, null) || { width: "4px" }).width)),
        c.removeChild(g),
        (b = c = null));
    },
    pb,
  ...
  v.opacity = /^0.5/.test(pb.style.opacity);
  v.cssFloat = !!pb.style.cssFloat;
  bb.style.backgroundClip = "content-box";
  bb.cloneNode(!0).style.backgroundClip = "";
  v.clearCloneStyle = "content-box" === bb.style.backgroundClip;
  pb = bb = null;
  f.extend(v, {
  ...
  f.extend({
    ...
    style: function (a, b, c, k) {
      if (a && !(3 === a.nodeType || 8 === a.nodeType || !a.style)) {
        ...
        if (void 0 !== c) {
          n = typeof c;
          if ("string" === n && (d = Hd.exec(c)))
            (c = (d[1] + 1) * d[2] + parseFloat(f.css(a, b))), (n = "number");
          if (!(null == c || c !== c))
            if (
              ("number" === n && !f.cssNumber[r] && (c += "px"),
              !v.clearCloneStyle &&
                "" === c &&
                0 === b.indexOf("background") &&
                (h[b] = "inherit"),
              !e || !("set" in e) || void 0 !== (c = e.set(a, c, k)))
            )
              try {
                (h[b] = ""), (h[b] = c);
              } catch (q) {}
        } else
          return e && "get" in e && void 0 !== (d = e.get(a, !1, k)) ? d : h[b];
      }
    },
    css: function (a, b, c, k) {
      ...
      (n = f.cssHooks[b] || f.cssHooks[n]) &&
        "get" in n &&
        (d = n.get(a, !0, c));
      void 0 === d && (d = Qa(a, b, k));
      "normal" === d && b in Jc && (d = Jc[b]);
      return "" === c || c
        ? ((a = parseFloat(d)), !0 === c || f.isNumeric(a) ? a || 0 : d)
        : d;
    },
  });
  f.each(["height", "width"], function (a, b) {
    f.cssHooks[b] = {
      get: function (a, g, c) {
        if (g)
          return 0 === a.offsetWidth && Gd.test(f.css(a, "display"))
            ? f.swap(a, Id, function () {
                return W(a, b, c);
              })
            : W(a, b, c);
      },
        ...
        return la(
          ...
          c
            ? x(
                ...
                b,
                c,
                v.boxSizing() && "border-box" === f.css(a, "boxSizing", !1, k),
                k
              )
            : 0
        );
    ...
    (f.cssHooks.opacity = {
      ...
      set: function (a, b) {
        ...
        if (
          ...
          if ((c.removeAttribute("filter"), "" === b || (k && !k.filter)))
            return;
        c.filter = ec.test(n) ? n.replace(ec, d) : n + " " + d;
      },
    });
  f.cssHooks.marginRight = fb(v.reliableMarginRight, function (a, b) {
    if (b)
      return f.swap(a, { display: "inline-block" }, Qa, [a, "marginRight"]);
  });
  f.each({ margin: "", padding: "", border: "Width" }, function (a, b) {
    f.cssHooks[a + b] = {
      expand: function (c) {
        var f = 0,
          k = {};
        for (c = "string" === typeof c ? c.split(" ") : [c]; 4 > f; f++)
          k[a + Oa[f] + b] = c[f] || c[f - 2] || c[0];
        return k;
      },
    };
    Ic.test(a) || (f.cssHooks[a + b].set = la);
  });
  f.fn.extend({
    css: function (a, b) {
      return Ua(
        ...
        function (a, b, g) {
          ...
          if (f.isArray(b)) {
            g = Pa(a);
            for (c = b.length; d < c; d++) k[b[d]] = f.css(a, b[d], !1, g);
            return k;
          }
    ...
    _default: {
      ...
      set: function (a) {
        if (f.fx.step[a.prop]) f.fx.step[a.prop](a);
          ...
          a.elem.style &&
          (null != a.elem.style[f.cssProps[a.prop]] || f.cssHooks[a.prop])
            ? f.style(a.elem, a.prop, a.now + a.unit)
            : (a.elem[a.prop] = a.now);
      },
    },
  };
      ...
      function (a, b, c) {
        ...
        if (1 === a.nodeType && ("height" in b || "width" in b))
          (c.overflow = [l.overflow, l.overflowX, l.overflowY]),
            ...
            "inline" === d &&
              "none" === f.css(a, "float") &&
              (!v.inlineBlockNeedsLayout || "inline" === h
      ...
      "*": [
        function (a, b) {
          var c = this.createTween(a, b),
            ...
            e =
              (f.cssNumber[a] || ("px" !== n && +k)) &&
              Kc.exec(f.css(c.elem, a)),
            r = 1,
            h = 20;
          if (e && e[3] !== n) {
            n = n || e[3];
            d = d || [];
            e = +k || 1;
            do (r = r || ".5"), (e /= r), f.style(c.elem, a, e + n);
            while (r !== (r = c.cur() / k) && 1 !== r && --h);
          }
          d &&
            ((e = c.start = +e || +k || 0),
            (c.unit = n),
            (c.end = d[1] ? e + (d[1] + 1) * d[2] : +d[2]));
          return c;
        },
      ],
    };
  f.Animation = f.extend(jb, {
    tweener: function (a, b) {
      ...
      for (var c, k = 0, d = a.length; k < d; k++)
        (c = a[k]), (ib[c] = ib[c] || []), ib[c].unshift(b);
    },
  ...
  f.speed = function (a, b, c) {
    ...
    k.duration = f.fx.off
      ? 0
      : "number" === typeof k.duration
      ? k.duration
      : k.duration in f.fx.speeds
      ? f.fx.speeds[k.duration]
  ...
  f.fn.extend({
    fadeTo: function (a, b, c, k) {
      return this.filter(hb)
        .css("opacity", 0)
        .show()
        .end()
        .animate({ opacity: b }, a, c, k);
    },
    ...
    stop: function (a, b, c) {
      ...
      return this.each(function () {
        ...
        else for (d in e) e[d] && e[d].stop && Kd.test(d) && k(e[d]);
        for (d = n.length; d--; )
          if (n[d].elem === this && (null == a || n[d].queue === a))
            n[d].anim.stop(c), (b = !1), n.splice(d, 1);
  ...
  Ka = qb.getElementsByTagName("input")[0];
  Ib.style.cssText = "top:1px";
  v.getSetAttribute = "t" !== qb.className;
  v.style = /top/.test(Ib.getAttribute("style"));
  v.hrefNormalized = "/a" === Ib.getAttribute("href");
  v.checkOn = !!Ka.value;
  v.optSelected = gc.selected;
  v.enctype = !!y.createElement("form").enctype;
  fc.disabled = !0;
  v.optDisabled = !gc.disabled;
  Ka = y.createElement("input");
  Ka.setAttribute("value", "");
  v.input = "" === Ka.getAttribute("value");
  Ka.value = "t";
  Ka.setAttribute("type", "radio");
  v.radioValue = "t" === Ka.value;
  var Ld = /\r/g;
  f.fn.extend({
    val: function (a) {
      var b,
      ...
      if (arguments.length)
        return (
          ...
          this.each(function (c) {
            if (
              1 === this.nodeType &&
              ((c = k ? a.call(this, c, f(this).val()) : a),
              null == c
                ? (c = "")
                : "number" === typeof c
                ? (c += "")
      ...
      if (d) {
        if (
          (b = f.valHooks[d.type] || f.valHooks[d.nodeName.toLowerCase()]) &&
          "get" in b &&
          void 0 !== (c = b.get(d, "value"))
        )
          return c;
        c = d.value;
        return "string" === typeof c ? c.replace(Ld, "") : null == c ? "" : c;
      }
    },
  });
  f.extend({
    valHooks: {
      ...
      select: {
        get: function (a) {
          for (
            var b,
              c = a.options,
              k = a.selectedIndex,
              d = (a = "select-one" === a.type || 0 > k) ? null : [],
              n = a ? k + 1 : c.length,
              e = 0 > k ? n : a ? k : 0;
            e < n;
            e++
            ...
            if (
              ...
              (b.selected || e === k) &&
                ...
                (!b.parentNode.disabled ||
                  !f.nodeName(b.parentNode, "optgroup")))
            ) {
              b = f(b).val();
              if (a) return b;
              d.push(b);
        ...
        set: function (a, b) {
          for (var c, k, d = a.options, n = f.makeArray(b), e = d.length; e--; )
            if (((k = d[e]), 0 <= f.inArray(f.valHooks.option.get(k), n)))
              try {
                k.selected = c = !0;
              } catch (r) {
                k.scrollHeight;
  ...
  var cb,
    Lc,
    La = f.expr.attrHandle,
    hc = /^(?:checked|selected)$/i,
    Va = v.getSetAttribute,
    Jb = v.input;
  f.fn.extend({
    attr: function (a, b) {
      return Ua(this, f.attr, a, b, 1 < arguments.length);
    },
  ...
  f.extend({
    attr: function (a, b, c) {
      var k,
        ...
        n = a.nodeType;
      if (a && !(3 === n || 8 === n || 2 === n)) {
        if (typeof a.getAttribute === ka) return f.prop(a, b, c);
        if (1 !== n || !f.isXMLDoc(a))
          (b = b.toLowerCase()),
            (k = f.attrHooks[b] || (f.expr.match.bool.test(b) ? Lc : cb));
        if (void 0 !== c)
        ...
        for (; (c = n[d++]); )
          (k = f.propFix[c] || c),
            f.expr.match.bool.test(c)
              ? (Jb && Va) || !hc.test(c)
                ? (a[k] = !1)
                : (a[f.camelCase("default-" + c)] = a[k] = !1)
              : f.attr(a, c, ""),
            a.removeAttribute(Va ? c : k);
    },
    attrHooks: {
      type: {
        set: function (a, b) {
      ...
      (Jb && Va) || !hc.test(b)
        ? function (a, b, g) {
            ...
            g ||
              ((f = La[b]),
              (La[b] = k),
              (k = null != c(a, b, g) ? b.toLowerCase() : null),
              (La[b] = f));
            return k;
          }
        : function (a, b, g) {
            if (!g)
              return a[f.camelCase("default-" + b)] ? b.toLowerCase() : null;
          };
  });
  if (!Jb || !Va)
    f.attrHooks.value = {
    ...
    (La.id =
      ...
      La.coords =
        function (a, b, c) {
          var k;
          if (!c)
            return (k = a.getAttributeNode(b)) && "" !== k.value
              ? k.value
              : null;
        }),
    (f.valHooks.button = {
  ...
  f.fn.extend({
    prop: function (a, b) {
      return Ua(this, f.prop, a, b, 1 < arguments.length);
    },
  ...
  f.extend({
    ...
    prop: function (a, b, c) {
      ...
      n = a.nodeType;
      if (a && !(3 === n || 8 === n || 2 === n)) {
        if ((n = 1 !== n || !f.isXMLDoc(a)))
          (b = f.propFix[b] || b), (d = f.propHooks[b]);
        return void 0 !== c
          ? d && "set" in d && void 0 !== (k = d.set(a, c, b))
            ? k
            : (a[b] = c)
          : d && "get" in d && null !== (k = d.get(a, b))
          ? k
          : a[b];
      }
    },
    propHooks: {
      tabIndex: {
        get: function (a) {
          ...
          return b
            ? parseInt(b, 10)
            : Md.test(a.nodeName) || (Nd.test(a.nodeName) && a.href)
            ? 0
            : -1;
        },
      },
  ...
  v.enctype || (f.propFix.enctype = "encoding");
  var ic = /[\t\r\n\f]/g;
  f.fn.extend({
    addClass: function (a) {
      var b,
      ...
      if (b)
        for (b = (a || "").match(va) || []; e < r; e++)
          if (
            ((c = this[e]),
            (k =
              1 === c.nodeType &&
              (c.className ? (" " + c.className + " ").replace(ic, " ") : " ")))
          ) {
            for (n = 0; (d = b[n++]); )
              0 > k.indexOf(" " + d + " ") && (k += d + " ");
            k = f.trim(k);
    ...
    toggleClass: function (a, b) {
      ...
      return "boolean" === typeof b && "string" === c
        ...
        : this.each(function () {
            if ("string" === c)
              for (
                var b, k = 0, d = f(this), n = a.match(va) || [];
                (b = n[k++]);

              )
                d.hasClass(b) ? d.removeClass(b) : d.addClass(b);
            else if (c === ka || "boolean" === c)
    ...
    hasClass: function (a) {
      ...
      for (var b = 0, c = this.length; b < c; b++)
        if (
          1 === this[b].nodeType &&
          0 <= (" " + this[b].className + " ").replace(ic, " ").indexOf(a)
        )
          return !0;
      return !1;
    },
  ...
  f.parseXML = function (b) {
    ...
    try {
      a.DOMParser
        ? ((k = new DOMParser()), (c = k.parseFromString(b, "text/xml")))
  ...
  try {
    ...
    (Ma = y.createElement("a")), (Ma.href = ""), (Ma = Ma.href);
  }
  Wa = Nc.exec(Ma.toLowerCase()) || [];
  f.extend({
    active: 0,
    lastModified: {},
    etag: {},
    ...
    ajaxSetup: function (a, b) {
      return b ? wa(wa(a, f.ajaxSettings), b) : wa(f.ajaxSettings, a);
    },
    ajaxPrefilter: kb(Oc),
    ajaxTransport: kb(Nb),
    ajax: function (a, b) {
      function c(a, b, g, k) {
        ...
        if (2 !== fa) {
          ...
          if (g) {
            p = j;
            for (
              var M = s, S, w, E, C, U = p.contents, N = p.dataTypes;
              "*" === N[0];

            )
              N.shift(),
                void 0 === w &&
                  (w = p.mimeType || M.getResponseHeader("Content-Type"));
            if (w)
              for (C in U)
                if (U[C] && U[C].test(w)) {
                  N.unshift(C);
          ...
          a: {
            ...
            var v,
              ...
              U = g.dataTypes.slice();
            if (U[1])
              for (aa in g.converters) M[aa.toLowerCase()] = g.converters[aa];
            for (C = U.shift(); C; )
              if (
                (g.responseFields[C] && (w[g.responseFields[C]] = S),
                !u && E && g.dataFilter && (S = g.dataFilter(S, g.dataType)),
                (u = C),
                (C = U.shift()))
              )
                if ("*" === C) C = u;
                  ...
                  if (!aa)
                    for (v in M)
                      if (
                        ...
                        !0 === aa
                          ? (aa = M[v])
                          : !0 !== M[v] && ((C = p[0]), U.unshift(p[1]));
                        break;
                      }
                  if (!0 !== aa)
                    if (aa && g["throws"]) S = aa(S);
                    else
                      try {
                        S = aa(S);
                      } catch (Xa) {
          ...
          if (k)
            j.ifModified &&
              ((m = s.getResponseHeader("Last-Modified")) &&
                (f.lastModified[n] = m),
              (m = s.getResponseHeader("etag")) && (f.etag[n] = m)),
              204 === a || "HEAD" === j.type
                ? (m = "nocontent")
                : 304 === a
                ? (m = "notmodified")
                : ((m = p.state), (d = p.data), (l = p.error), (k = !l));
          else if (((l = m), a || !m)) (m = "error"), 0 > a && (a = 0);
          s.status = a;
          s.statusText = (b || m) + "";
          k ? T.resolveWith(A, [d, m, s]) : T.rejectWith(A, [s, m, l]);
          s.statusCode(K);
          K = void 0;
          h && z.trigger(k ? "ajaxSuccess" : "ajaxError", [s, j, k ? d : l]);
          t.fireWith(A, [s, m]);
          h &&
            (z.trigger("ajaxComplete", [s, j]),
      ...
      var k,
        ...
        s = {
          ...
          statusCode: function (a) {
            var b;
            if (a)
              if (2 > fa) for (b in a) K[b] = [K[b], a[b]];
      ...
      j.data &&
        ...
        (j.data = f.param(j.data, j.traditional));
      ub(Oc, j, b, s);
      if (2 === fa) return s;
      ...
      j.hasContent ||
        (j.data &&
          ((n = j.url += (kc.test(n) ? "&" : "?") + j.data), delete j.data),
        !1 === j.cache &&
          (j.url = Mc.test(n)
            ? n.replace(Mc, "$1_=" + jc++)
            : n + (kc.test(n) ? "&" : "?") + "_=" + jc++));
      j.ifModified &&
        (f.lastModified[n] &&
          s.setRequestHeader("If-Modified-Since", f.lastModified[n]),
        f.etag[n] && s.setRequestHeader("If-None-Match", f.etag[n]));
      ...
      s.setRequestHeader(
        ...
        j.dataTypes[0] && j.accepts[j.dataTypes[0]]
          ? j.accepts[j.dataTypes[0]] +
              ("*" !== j.dataTypes[0] ? ", " + Pc + "; q=0.01" : "")
          : j.accepts["*"]
      );
      for (d in j.headers) s.setRequestHeader(d, j.headers[d]);
      if (j.beforeSend && (!1 === j.beforeSend.call(A, s, j) || 2 === fa))
        return s.abort();
      S = "abort";
      for (d in { success: 1, error: 1, complete: 1 }) s[d](j[d]);
      if ((q = ub(Nb, j, b, s))) {
        s.readyState = 1;
  ...
  f.each(["get", "post"], function (a, b) {
    f[b] = function (a, c, g, k) {
      ...
      return f.ajax({ url: a, type: b, dataType: k, data: c, success: g });
    };
  });
  f.each(
      ...
      return this.map(function () {
        ...
        .map(function (a, b) {
          ...
          return null == c
            ...
            : f.isArray(c)
            ? f.map(c, function (a) {
                return { name: b.name, value: a.replace(Qc, "\r\n") };
              })
  ...
  v.cors = !!Lb && "withCredentials" in Lb;
  (Lb = v.ajax = !!Lb) &&
      ...
      if (!a.crossDomain || v.cors) {
        ...
        return {
          send: function (c, k) {
            ...
            if (a.xhrFields) for (d in a.xhrFields) n[d] = a.xhrFields[d];
              ...
              if (b && (d || 4 === n.readyState))
                if (
                  ...
                  "string" === typeof n.responseText &&
                    (h.text = n.responseText);
                  try {
                    j = n.statusText;
                  } catch (q) {
                    j = "";
                  }
                  !r && a.isLocal && !a.crossDomain
                    ? (r = h.text ? 200 : 404)
                    : 1223 === r && (r = 204);
                }
  ...
  f.ajaxPrefilter("json jsonp", function (b, c, k) {
    ...
    if (r || "jsonp" === b.dataTypes[0])
      return (
        (d = b.jsonpCallback =
          f.isFunction(b.jsonpCallback) ? b.jsonpCallback() : b.jsonpCallback),
        r
          ? (b[r] = b[r].replace(lc, "$1" + d))
          : !1 !== b.jsonp &&
            (b.url += (kc.test(b.url) ? "&" : "?") + b.jsonp + "=" + d),
  ...
  f.fn.load = function (a, b, c) {
    ...
    f.isFunction(b)
      ? ((c = b), (b = void 0))
      : b && "object" === typeof b && (n = "POST");
    0 < e.length &&
      f
        .ajax({ url: a, type: n, dataType: "html", data: b })
        .done(function (a) {
          d = arguments;
  ...
  f.offset = {
    setOffset: function (a, b, c) {
      ...
      d = f.css(a, "top");
      k = f.css(a, "left");
      ("absolute" === e || "fixed" === e) && -1 < f.inArray("auto", [d, k])
        ? ((k = r.position()), (d = k.top), (k = k.left))
        : ((d = parseFloat(d) || 0), (k = parseFloat(k) || 0));
      f.isFunction(b) && (b = b.call(a, c, n));
      null != b.top && (j.top = b.top - n.top + d);
      null != b.left && (j.left = b.left - n.left + k);
  ...
  f.fn.extend({
    offset: function (a) {
      ...
      if (d) {
        ...
        typeof c.getBoundingClientRect !== ka &&
      ...
      f.fn[a] = function (k) {
        return Ua(
          ...
          function (a, k, g) {
            var d = ca(a);
            if (void 0 === g)
              return d ? (b in d ? d[b] : d.document.documentElement[k]) : a[k];
            d
              ? d.scrollTo(!c ? g : f(d).scrollLeft(), c ? g : f(d).scrollTop())
              : (a[k] = g);
          },
          a,
          k,
  ...
  f.each(["top", "left"], function (a, b) {
    f.cssHooks[b] = fb(v.pixelPosition, function (a, c) {
      if (c) return (c = Qa(a, b)), sb.test(c) ? f(a).position()[b] + "px" : c;
    });
  });
...
(function (a) {
  ...
  a.ajaxTransport("+script", function (a) {
    var h,
      e = document.head || jQuery("head")[0] || document.documentElement;
    return {
      send: function (j, t) {
        ...
        h.onload = h.onreadystatechange = function (a, e) {
          if (e || !h.readyState || /loaded|complete/.test(h.readyState))
  ...
  a.extend(a.support, { iecors: !!window.XDomainRequest });
  a.support.iecors
    ? a.ajaxTransport(function (a) {
        return {
          send: function (h, e) {
            ...
            a.xhrFields &&
              ((j.onerror = a.xhrFields.error),
              (j.ontimeout = a.xhrFields.timeout));
            j.open(a.type, a.url);
      ...
      a.ajaxTransport("binary", function (a) {
        ...
        return {
          send: function (e, j) {
            ...
            var m = !1;
            try {
              t.hasOwnProperty("responseType") &&
                ((t.responseType = "arraybuffer"), (m = !0));
            } catch (u) {}
            try {
              !m &&
                t.overrideMimeType &&
...
(function (a, m, l, h) {
  function e(e, l) {
    function s(b) {
      a(u).each(function () {
        self.Jmol &&
          (0 <= l.indexOf("mouseup") || 0 <= l.indexOf("touchend")) &&
          Jmol._setMouseOwner(null);
        var d = a(this);
        this !== b.target &&
          !d.has(b.target).length &&
          d.triggerHandler(l, [b.target, b]);
      });
    }
    l = l || e + h;
    var u = a(),
...
"undefined" == typeof jQuery &&
  alert("Note -- JSmoljQuery is required for JSmol, but it's not defined.");
self.Jmol || (Jmol = {});
Jmol._version ||
  (Jmol = (function (a) {
    var m = function (a) {
      ...
      m = {
        _version: "$Date: 2022-06-24 05:54:49 -0500 (Fri, 24 Jun 2022) $",
        _alertNoBinary: !0,
        _allowedJmolSize: [25, 2048, 300],
        _allowKeyboardFocus: !0,
        _appletCssClass: "",
        _appletCssText: "",
        _fileCache: null,
        _jarFile: null,
        ...
        db: {
          ...
          _nciLoadScript:
            ";n = ({molecule=1}.length < {molecule=2}.length ? 2 : 1); select molecule=n;display selected;center selected;",
          _pubChemLoadScript: "",
          ...
          _restQueryXml:
            "<orgPdbQuery><queryType>org.pdb.query.simple.AdvancedKeywordQuery</queryType><description>Text Search</description><keywords>QUERY</keywords></orgPdbQuery>",
          _restReportUrl:
            "http://www.pdb.org/pdb/rest/customReport?pdbids=IDLIST&customReportColumns=structureId,structureTitle",
        },
        _debugAlert: !1,
        _document: a,
        _isXHTML: !1,
    ...
    m._isFile && $.ajaxSetup({ mimeType: "text/plain" });
    m._ajaxTestSite = m._httpProto + "google.com";
    a =
      m._isFile ||
      0 == a.indexOf("http://localhost") ||
      0 == a.indexOf("http://127.");
    m._tracker =
      !a && "https://chemapps.stolaf.edu/jmol/JmolTracker.php?id=UA-45940799-1";
    m._isChrome = 0 <= navigator.userAgent.toLowerCase().indexOf("chrome");
    m._isSafari =
      !m._isChrome && 0 <= navigator.userAgent.toLowerCase().indexOf("safari");
...
(function (a, m) {
  ...
  a._fixProtocol = function (b) {
    0 <= b.indexOf("get3d=True") &&
      (b = b.replace(/get3d\=True/, "get3d=true"));
    return 0 == b.indexOf("http://www.rcsb.org/pdb/files/") &&
      0 > b.indexOf("/ligand/")
      ? "http://files.rcsb.org/view/" + b.substring(30).replace(/\.gz/, "")
      : 0 == b.indexOf("http://") &&
        ("https://" == a._httpProto ||
          0 < b.indexOf(".gov/") ||
          0 == b.indexOf("http://www.materialsproject"))
      ? "https" + b.substring(4)
      : b;
  };
  a._getNCIInfo = function (b, c) {
    return a._getFileData(
  ...
  e.browser = function () {
    for (
      var a = e.ua,
        c = "konqueror webkit omniweb opera webtv icab msie mozilla".split(" "),
        d = 0;
      d < c.length;
      d++
    )
  ...
  e.browserVersion = parseFloat(
    e.ua.substring(e.ua.indexOf(e.browserName) + e.browserName.length + 1)
  );
  ...
  e.allowHTML5 =
    "msie" != e.browserName || 0 > navigator.appVersion.indexOf("MSIE 8");
  ...
  e.supportsWebGL = function () {
    if (!a.featureDetection._webGLtest) {
      var b;
      a.featureDetection._webGLtest =
        h.WebGLRenderingContext &&
        ((b = l.createElement("canvas")).getContext("webgl") ||
  ...
  e.supportsJava = function () {
    a.featureDetection._javaEnabled ||
      (a.featureDetection._javaEnabled = a._isMsie
  ...
  e.compliantBrowser = function () {
    var a = !!l.getElementById,
      c = e.os;
    if (
      ("opera" == e.browserName && 7.54 >= e.browserVersion && "mac" == c) ||
      ("webkit" == e.browserName && 125.12 > e.browserVersion) ||
      ("msie" == e.browserName && "mac" == c) ||
      ("konqueror" == e.browserName && 3.3 >= e.browserVersion)
    )
      a = !1;
    return a;
  };
  ...
  e.useIEObject =
    "win" == e.os && "msie" == e.browserName && 5.5 <= e.browserVersion;
  e.useHtml4Object =
    ("mozilla" == e.browserName && 5 <= e.browserVersion) ||
    ("opera" == e.browserName && 8 <= e.browserVersion) ||
    "webkit" == e.browserName;
  ...
  a._getGrabberOptions = function (b) {
    if (0 == a._grabberOptions.length) return "";
    var c =
        '<input type="text" id="ID_query" onfocus="jQuery(this).select()" onkeypress="if(13==event.which){Jmol._applets[\'ID\']._search();return false}" size="32" value="" />',
      d =
        '<button id="ID_submit" onclick="Jmol._applets[\'ID\']._search()">Search</button></nobr>';
    1 == a._grabberOptions.length
      ? ((c = "<nobr>" + c + '<span style="display:none">'),
        (d = "</span>" + d))
      : (c += "<br /><nobr>");
    for (
      var c = c + '<select id="ID_select">', e = 0;
      e < a._grabberOptions.length;
      e++
    )
      var j = a._grabberOptions[e],
        c =
          c +
          ('<option value="' +
            j[0] +
  ...
  a._getScriptForDatabase = function (b) {
    return "$" == b
      ? a.db._nciLoadScript
      : ":" == b
      ? a.db._pubChemLoadScript
      : a.db._fileLoadScript;
  };
      ...
      switch (c) {
        case "=":
          ...
          for (d = 1; d < c.length; d++)
            e.push(
              '<tr><td valign=top><a href="javascript:Jmol.search(' +
                a._id +
                ",'=" +
                c[d].substring(0, 4) +
                "')\">" +
              ...
              e.push(
                "<td>" + c[d].split("Title>")[1].split("</")[0] + "</td></tr>"
              );
          e.push("</table>");
  ...
  a._isDatabaseCall = function (b) {
    return 0 <= a.db._databasePrefixes.indexOf(b.substring(0, 1));
  };
  a._getDirectDatabaseCall = function (b, c) {
    ...
    var d = 2,
      e = b.substring(0, d),
      j =
        a.db._DirectDatabaseCalls[e] ||
        a.db._DirectDatabaseCalls[(e = b.substring(0, --d))];
    j &&
      (":" == e
        ? ((e = b.toLowerCase()),
          isNaN(parseInt(b.substring(1)))
            ? 0 == e.indexOf(":smiles:")
              ? ((j += "?POST?smiles=" + b.substring(8)), (b = "smiles"))
              : 0 == e.indexOf(":cid:")
              ? (b = "cid/" + b.substring(5))
              : (0 == e.indexOf(":name:")
                  ? (b = b.substring(5))
                  : 0 == e.indexOf(":cas:") && (b = b.substring(4)),
                (b = "name/" + encodeURIComponent(b.substring(d))))
            : (b = "cid/" + b.substring(1)))
        : (b = encodeURIComponent(b.substring(d))),
      0 <= b.indexOf(".mmtf")
        ? (b = "https://mmtf.rcsb.org/v1.0/full/" + b.replace(/\.mmtf/, ""))
        : 0 <= j.indexOf("FILENCI")
        ? ((b = b.replace(/\%2F/g, "/")), (b = j.replace(/\%FILENCI/, b)))
        : (b = j.replace(/\%FILE/, b)));
    return b;
  };
  a._getRawDataFromServer = function (b, c, d, e, j, h) {
    b =
      "?call=getRawDataFromDatabase&database=" +
      b +
      (0 <= c.indexOf("?POST?") ? "?POST?" : "") +
      "&query=" +
      encodeURIComponent(c) +
      (j ? "&encoding=base64" : "") +
      (h ? "" : "&script=" + encodeURIComponent(a._getScriptForDatabase(b)));
    return a._contactServer(b, d, e);
  };
  a._checkFileName = function (b, c, d) {
    a._isDatabaseCall(c) &&
      (d && a._setQueryTerm(b, c),
      (c = a._getDirectDatabaseCall(c, !0)),
      a._isDatabaseCall(c) &&
        ((c = a._getDirectDatabaseCall(c, !1)), d && (d[0] = !0)));
    return c;
  };
  a._checkCache = function (b, c, d) {
    if (b._cacheFiles && a._fileCache && !c.endsWith(".js")) {
      if ((b = a._fileCache[c]))
        return (
          System.out.println(
            "using " + b.length + " bytes of cached data for " + c
          ),
          d(b),
          null
        );
  ...
  a._loadFileData = function (b, c, d, e) {
    ...
    j[0]
      ? a._getRawDataFromServer("_", c, d, e)
      : ((b = {
          type: "GET",
          dataType: "text",
          url: c,
  ...
  a._getInfoFromDatabase = function (b, c, d) {
    ...
    d =
      "?call=getInfoFromDatabase&database=" +
      c +
      "&query=" +
      encodeURIComponent(d);
    return a._contactServer(d, function (d) {
      a._setInfo(b, c, d);
    });
  };
  a._extractInfoFromRCSB = function (b, c, d, e) {
    ...
    if (0 != j && 4 == d.length && 1 != j) {
      ...
      var h = e.indexOf(d);
      0 < h &&
        0 <= "123456789".indexOf(d.substring(0, 1)) &&
        (e = d + "," + e.substring(0, h) + e.substring(h + 5));
  ...
  a._checkAjaxPost = function (a) {
    ...
    0 < c &&
      ((a.data = a.url.substring(c + 6)),
      (a.url = a.url.substring(0, c)),
      (a.type = "POST"),
  ...
  a._setQueryTerm = function (b, c) {
    if (c && b._hasOptions && "http://" != c.substring(0, 7)) {
      if (a._isDatabaseCall(c)) {
        ...
        var e = a._getElement(b, "select");
        if (e && e.options)
          for (var j = 0; j < e.options.length; j++)
            e[j].value == d && (e[j].selected = !0);
      }
      a.$val(a.$(b, "query"), c);
    }
  };
  a._search = function (b, c, d) {
    ...
    c || (c = a.$val(a.$(b, "query")));
    0 == c.indexOf("!")
      ? b._script(c.substring(1))
      : (c && (c = c.replace(/\"/g, "")),
        b._showInfo(!1),
        a._searchMol(b, c, d, !0));
  };
  a._searchMol = function (b, c, d, e) {
    var j;
    a._isDatabaseCall(c)
      ? ((j = c.substring(0, 1)), (c = c.substring(1)))
      : (j = b._hasOptions ? a.$val(a.$(b, "select")) : "$");
    "=" == j && 3 == c.length && (c = "=" + c);
    var h = j + c;
    if (c && !(0 > h.indexOf("?") && h == b._thisJmolModel)) {
      ...
      e &&
      null != b._viewSet &&
      null != (l = a.View.__findView(b._viewSet, { chemID: h }))
        ? a.View.__setView(l, b, !1)
        : ("$" == j || ":" == j
            ? (b._jmolFileType = "MOL")
            : "=" == j && (b._jmolFileType = "PDB"),
          b._searchDatabase(c, j, d));
    }
  };
  a._searchDatabase = function (b, c, d, e) {
    b._showInfo(!1);
    return 0 <= c.indexOf("?")
      ? (a._getInfoFromDatabase(b, d, c.split("?")[0]), !0)
      : a.db._DirectDatabaseCalls[d]
      ? (b._loadFile(d + c, e), !0)
      : !1;
  };
  a._syncBinaryOK = "?";
  ...
  a._binaryTypes =
    "mmtf .gz .bz2 .jpg .gif .png .zip .jmol .bin .smol .spartan .pmb .mrc .map .ccp4 .dn6 .delphi .omap .pse .dcd .lut .uk/pdbe/densities/".split(
      " "
    );
  ...
  a._getFileData = function (b, c, d) {
    ...
    j && ((b = b.replace(/\.gz/, "")), (e = !1));
    var j = e && !c && !a._canSyncBinary(j),
      h = 0 <= b.indexOf("?POST?");
    0 == b.indexOf("file:/") &&
      0 != b.indexOf("file:///") &&
      (b = "file://" + b.substring(5));
    var l =
        0 > b.indexOf("://") ||
        (0 == b.indexOf(document.location.protocol) &&
          0 <= b.indexOf(document.location.host)),
      t = "https://" == a._httpProto && 0 == b.indexOf("http://"),
      m = a._isDirectCall(b);
    !m &&
      0 <= b.indexOf("?ALLOWSORIGIN?") &&
      ((m = !0), (b = b.replace(/\?ALLOWSORIGIN\?/, "")));
    var s = !l && a.$supportsIECrossDomainScripting(),
      u = null;
    if (t || j || (!l && !m) || (!c && s))
      u = a._getRawDataFromServer("_", b, c, c, j, !0);
    else {
      b = b.replace(/file:\/\/\/\//, "file://");
      var O = { dataType: e ? "binary" : "text", async: !!c };
      h
        ? ((O.type = "POST"),
          (O.url = b.split("?POST?")[0]),
          (O.data = b.split("?POST?")[1]))
        : ((O.type = "GET"), (O.url = b));
      c &&
        ((O.success = function () {
          c(a._xhrReturn(O.xhr));
        }),
        (O.error = function () {
          c(O.xhr.statusText);
        }));
      O.xhr = a.$ajax(O);
      c || (u = a._xhrReturn(O.xhr));
    }
    if (!d) return u;
    null == u && ((u = ""), (e = !1));
  ...
  a._xhrReturn = function (a) {
    return (!a.responseText && "" !== a.responseText) ||
      (self.Clazz && Clazz.instanceOf(a.response, self.ArrayBuffer))
      ? a.response || a.statusText
      : a.responseText;
  };
  ...
  a._getFileType = function (a) {
    ...
    if ("$" == c || ":" == c) return "MOL";
    if ("=" == c) return "=" == a.substring(1, 2) ? "LCIF" : "PDB";
  ...
  a.loadFileAsynchronously = function (b, c, d, e) {
    ...
    if (!a.featureDetection.hasFileReader)
      return b
        ? b.setData(
            "Local file reading is not enabled in your browser",
            null,
            null,
            e,
            c
          )
        : alert("Local file reading is not enabled in your browser");
    c._localReader ||
      ((h =
        '<div id="ID" style="z-index:' +
        a._getZ(c, "fileOpener") +
        ';position:absolute;background:#E0E0E0;left:10px;top:10px"><div style="margin:5px 5px 5px 5px;"><button id="ID_loadurl">URL</button><input type="file" id="ID_files" /><button id="ID_loadfile">load</button><button id="ID_cancel">cancel</button></div><div>'),
      a.$after(
        "#" + c._id + "_appletdiv",
        h.replace(/ID/g, c._id + "_localReader")
      ),
      (c._localReader = a.$(c, "localReader")));
    ...
    a.$appEvent(c, "localReader_loadfile", "click", function () {
      ...
      j.onloadend = function (j) {
        j.target.readyState == FileReader.DONE &&
          (a._hideLocalFileReader(c, 0),
          a._setData(b, d.name, d.name, j.target.result, e, c));
      };
      try {
  ...
  a._setData = function (b, c, d, e, j, h) {
    e && (e = a._strToBytes(e));
    null != e &&
      (null == b || 0 <= c.indexOf(".jdx")) &&
      a.Cache.put("cache://" + c, e);
    null == b
      ? h._applet.openFileAsyncSpecial(null == e ? c : "cache://" + c, 1)
      : b.setData(c, d, e, j);
  };
    ...
    if (d) {
      ...
      b = {
        ...
        data:
          "string" == typeof data
            ? d
            : ";base64," + (JU || J.util).Base64.getBase64(d).toString(),
        processData: !1,
      };
  ...
  a._saveFile = function (b, c, d, e) {
    if (a._localFileSaveFunction && a._localFileSaveFunction(b, c)) return "OK";
    ...
    c =
      j && 0 <= c.indexOf(";base64,")
        ? c.split(";base64,")[1]
        : (JU || J.util).Base64.getBase64(
            j ? c.getBytes("UTF-8") : c
          ).toString();
    e || (e = "base64");
    (j = a._serverUrl) && 0 <= j.indexOf("your.server") && (j = "");
    a._useDataURI || !j
      ? ((e = document.createElement("a")),
        (e.href = "data:" + d + ";base64," + c),
        (e.type = d || "text/plain;charset=utf-8"),
        (e.download = b),
        (e.target = "_blank"),
        m("body").append(e),
        e.click(),
      ...
      : (a._formdiv ||
          (a.$after(
            "body",
            '<div id="__jsmolformdiv__" style="display:none">\t\t\t\t\t\t<form id="__jsmolform__" method="post" target="_blank" action="">\t\t\t\t\t\t<input name="call" value="saveFile"/>\t\t\t\t\t\t<input id="__jsmolmimetype__" name="mimetype" value=""/>\t\t\t\t\t\t<input id="__jsmolencoding__" name="encoding" value=""/>\t\t\t\t\t\t<input id="__jsmolfilename__" name="filename" value=""/>\t\t\t\t\t\t<textarea id="__jsmoldata__" name="data"></textarea>\t\t\t\t\t\t</form>\t\t\t\t\t\t</div>'
          ),
          (a._formdiv = "__jsmolform__")),
        a.$attr(a._formdiv, "action", j + "?" + new Date().getMilliseconds()),
        a.$val("__jsmoldata__", c),
        a.$val("__jsmolfilename__", b),
        a.$val("__jsmolmimetype__", d),
        a.$val("__jsmolencoding__", e),
        a.$submit("__jsmolform__"),
        a.$val("__jsmoldata__", ""),
  ...
  a._strToBytes = function (a) {
    ...
    for (var c = Clazz.newByteArray(a.length, 0), d = a.length; 0 <= --d; )
      c[d] = a.charCodeAt(d) & 255;
    return c;
  };
  a._setConsoleDiv = function (a) {
  ...
  a._registerApplet = function (b, c) {
    return (window[b] =
      a._applets[b] =
      a._applets.master =
      a._applets[b + "__" + a._syncId + "__"] =
        c);
  };
  a._readyCallback = function (b, c, d, e, j) {
    b = b.split("_object")[0];
    var h = a._applets[b];
    if ((d = d.booleanValue ? d.booleanValue() : d))
      (h._appletPanel = j || e), (h._applet = e);
  ...
  a._getWrapper = function (b, c) {
    ...
    if (c) {
      ...
      if (b._coverImage)
        var e =
            ' onclick="Jmol.coverApplet(ID, false)" title="' +
            b._coverTitle +
            '"',
          j =
            '<image id="ID_coverclickgo" src="' +
            b._makeLiveImage +
            '" style="width:25px;height:25px;position:absolute;bottom:10px;left:10px;z-index:' +
            a._getZ(b, "coverImage") +
            ';opacity:0.5;"' +
            e +
            " />",
          e =
            '<div id="ID_coverdiv" style="background-color:red;z-index:' +
            a._getZ(b, "coverImage") +
      ...
      j = b._isJava
        ? ""
        : '<image id="ID_waitimage" src="' +
          b._j2sPath +
          '/img/cursor_wait.gif" style="display:none;position:absolute;bottom:10px;left:10px;z-index:' +
          a._getZ(b, "coverImage") +
          ';" />';
      ...
      d =
        '...<div id="ID_appletinfotablediv" style="width:Wpx;height:Hpx;position:relative;font-size:14px;text-align:left">IMG WAIT......<div id="ID_appletdiv" style="z-index:' +
        a._getZ(b, "header") +
      ...
      d =
        '......</div>......<div id="ID_2dappletdiv" style="position:absolute;width:100%;height:100%;overflow:hidden;display:none"></div>......<div id="ID_infotablediv" style="width:100%;height:100%;position:absolute;top:0px;left:0px">.........<div id="ID_infoheaderdiv" style="height:20px;width:100%;background:yellow;display:none"><span id="ID_infoheaderspan"></span><span id="ID_infocheckboxspan" style="position:absolute;text-align:right;right:1px;"><a href="javascript:Jmol.showInfo(ID,false)">[x]</a></span></div>.........<div id="ID_infodiv" style="position:absolute;top:20px;bottom:0px;width:100%;height:100%;overflow:auto"></div>......</div>...</div>';
    return d
      .replace(/\.\.\./g, "")
      .replace(/[\n\r]/g, "")
      .replace(/ID/g, b._id);
  ...
  a._hideLoadingSpinner = function (b) {
    b._spinner && a.$css(a.$(b, "appletdiv"), { "background-image": "" });
  };
  ...
  a._domWrite = function (b) {
    for (var c = [0]; c[0] < b.length; ) {
      ...
      if (!d) break;
      a._XhtmlAppendChild
        ? a._XhtmlElement.appendChild(d)
        : a._XhtmlElement.parentNode.insertBefore(d, _jmol.XhtmlElement);
    }
  };
  ...
  a._setObject = function (b, c, d) {
    ...
    (b._z = d.z) ||
      (d.zIndexBase && (b._z = b.__Info.z = a._getZOrders(d.zIndexBase)));
    b._width = d.width;
    b._height = d.height;
    b._noscript = !b._isJava && d.noscript;
    b._console = d.console;
    ...
    b._coverTitle ||
      (b._coverTitle = b._deferApplet
        ? "activate 3D model"
        : "3D model is loading...");
    b._containerWidth =
      b._width + (b._width == parseFloat(b._width) ? "px" : "");
    b._containerHeight =
      b._height + (b._height == parseFloat(b._height) ? "px" : "");
    b._info = "";
    ...
    b._coverImage &&
      !b._deferApplet &&
      (b._readyScript += ";javascript " + c + "._displayCoverImage(false)");
    b._src = d.src;
  };
  a._addDefaultInfo = function (b, c) {
    for (var d in c) "undefined" == typeof b[d] && (b[d] = c[d]);
    a._use && (b.use = a._use);
    0 <= b.use.indexOf("SIGNED") &&
      (0 > b.jarFile.indexOf("Signed") &&
        (b.jarFile = b.jarFile.replace(/Applet/, "AppletSigned")),
      (b.use = b.use.replace(/SIGNED/, "JAVA")),
      (b.isSigned = !0));
  };
  a._syncedApplets = [];
  a._syncedCommands = [];
  ...
  a._setReady = function (b) {
    ...
    for (var c = 0, d = 0; d < a._syncedApplets.length; d++) {
      if (a._syncedApplets[d] == b._id)
        (a._syncedApplets[d] = b), (a._syncedReady[d] = 1);
  ...
  a._setDestroy = function (b) {
    a.featureDetection.allowDestroy &&
      a.$windowOn("beforeunload", function () {
        a._destroy(b);
      });
  };
  a._destroy = function (b) {
    try {
      ...
      b._canvas = null;
      for (var c = 0, d = 0; d < a._syncedApplets.length; d++)
        a._syncedApplets[d] == b && (a._syncedApplets[d] = null),
          a._syncedApplets[d] && c++;
      0 < c || a._clearVars();
    } catch (e) {}
  };
  a._setSyncReady = function () {
    a._syncReady = !0;
    for (var b = "", c = 0; c < a._syncedApplets.length; c++)
      a._syncedCommands[c] &&
        (b +=
          "Jmol.script(Jmol._syncedApplets[" +
          c +
  ...
  a._mySyncCallback = function (b, c) {
    app = a._applets[b];
    if (app._viewSet) a.View.updateFromSync(app, c);
    else {
      if (!a._syncReady || !a._isJmolJSVSync) return 1;
      for (var d = 0; d < a._syncedApplets.length; d++)
        0 <= c.indexOf(a._syncedApplets[d]._syncKeyword) &&
          a._syncedApplets[d]._syncScript(c);
      return 0;
    }
  };
  ...
  a._evalJSON = function (a, c) {
    ...
    if (!a) return [];
    if ("{" != a.charAt(0))
      return 0 <= a.indexOf(" | ") && (a = a.replace(/\ \|\ /g, "\n")), a;
  ...
  a._setMouseOwner = function (b, c) {
    null == b || c
      ? (a._mouseOwner = b) && b._applet && (a._lastAppletID = b._applet._id)
      : a._mouseOwner == b && (a._mouseOwner = null);
  };
  ...
  a._jsGetXY = function (b, c) {
    if (!b.applet._ready || (a._touching && 0 > c.type.indexOf("touch")))
      return !1;
    var d = a.$offset(b.id),
      e,
      j = c.originalEvent;
    ...
    j.targetTouches && j.targetTouches[0]
      ? ((e = j.targetTouches[0].pageX - d.left),
        (d = j.targetTouches[0].pageY - d.top))
      : j.changedTouches
      ? ((e = j.changedTouches[0].pageX - d.left),
        (d = j.changedTouches[0].pageY - d.top))
      : ((e = c.pageX - d.left), (d = c.pageY - d.top));
    return void 0 == e
      ? null
      : [Math.round(e), Math.round(d), a._jsGetMouseModifiers(c)];
  };
  ...
  a._jsSetMouse = function (b) {
    ...
    a.$bind(b, "mousedown touchstart", function (d) {
      ...
      j &&
        (2 != d.button && a.Swing.hideMenus(b.applet),
        b.applet._processEvent(501, j));
      return !!e;
    });
    ...
    a.$bind(b, "keydown keyup", function (d) {
      if (c(d)) return !0;
      d.stopPropagation();
      d.preventDefault();
      var e = a._jsGetXY(b, d),
        j = "keydown" == d.type ? 401 : 402;
      b.applet._processKeyEvent && b.applet._processKeyEvent(j, e, d);
      return !0;
    });
    a._drag = function (b, c) {
      c.stopPropagation();
      c.preventDefault();
      if ("touchmove" == c.type && a._gestureUpdate(b, c)) return !1;
    ...
    a.$bind(b, "DOMMouseScroll mousewheel", function (d) {
      ...
      var e = d.originalEvent,
        e = e.detail
          ? e.detail
          : ("mac" == a.featureDetection.os ? 1 : -1) * e.wheelDelta;
      d = a._jsGetMouseModifiers(d);
      b.applet._processEvent(507, [0 > e ? -1 : 1, 0, d]);
      return !1;
    });
  ...
  a._jsUnsetMouse = function (b) {
    ...
    a.$bind(
      b,
      "mousedown touchstart mousemove touchmove mouseup touchend DOMMouseScroll mousewheel contextmenu mouseout mouseenter",
      null
    );
    a._setMouseOwner(null);
  };
    ...
    b.setContainer ||
      ((b.setContainer = function (b) {
        ...
        b.bind("mousemove touchmove", function (b) {
          if (d.isDragging && a._mouseOwner == d) return d.mouseMove(b), !1;
        });
      ...
      (b.mouseUp = function (b) {
        if (this.isDragging && a._mouseOwner == this)
          return (
            (this.pageX0 += b.pageX - this.pageX),
            (this.pageY0 += b.pageY - this.pageY),
            (this.isDragging = !1)
          );
        a._setMouseOwner(null);
      }),
      (b.setPosition = function () {
        if (null === a._mousePageX) {
          var b = a.$offset(
            this.applet._id + "_" + (this.applet._is2D ? "canvas2d" : "canvas")
          );
          a._mousePageX = b.left;
          a._mousePageY = b.top;
        }
        this.pageX0 = a._mousePageX;
        this.pageY0 = a._mousePageY;
        this.container.css({
      ...
      (b.mouseMove = function (b) {
        if (this.isDragging && a._mouseOwner == this) {
          ...
          a._mousePageX = d;
          a._mousePageY = b;
          this.container.css({ top: b + "px", left: d + "px" });
        }
      }),
      (b.dragBind = function (b) {
        ...
        if (b) {
          var d = this;
          this.container.bind(
            "mousemoveoutjsmol touchmoveoutjsmol",
            function (a, b, c) {
              d.mouseMove(c);
            }
          );
          this.container.bind(
            "mouseupoutjsmol touchendoutjsmol",
            function (a, b, c) {
              d.mouseUp(c);
            }
          );
  ...
  s.setDialog = function (b) {
    ...
    d[0]
      ...
      : (a.$after(
        ...
        (d = a._$(c)),
        (b.container = d),
        (e.applet = b.manager.vwr.html5Applet),
        e.setContainer(d),
        (e.dialog = b),
        e.setPosition(),
        e.dragBind(!0),
  ...
  s.click = function (b, c) {
    ...
    if (d) {
      ...
      if (0 <= e.indexOf("JCheck")) d.selected = b.checked;
        ...
        null != d.text &&
        ((d.text = b.value), c && 13 != (c.charCode || c.keyCode))
      )
        return;
    }
  ...
  s.hideMenus = function (a) {
    if ((a = a._menus)) for (var c in a) a[c]._visible && s.hideMenu(a[c]);
  };
  s.windowClosing = function (b) {
    b = s.htDialogs[a.$getAncestorDiv(b.id, "JDialog").id];
  ...
  a._track = function (b) {
    if (a._tracker) {
      try {
        var c =
          '<iframe style="display:none" width="0" height="0" frameborder="0" tabindex="-1" src="' +
          (a._tracker +
            "&applet=" +
            b._jmolType +
            "&version=" +
  ...
  a.getProfile = function (a) {
    if (self.Clazz && self.JSON)
      return (
        u || Clazz._startProfiling((u = 0 == arguments.length || a)),
        Clazz.getProfile()
      );
  };
  ...
  a._getAttr = function (a, c) {
    var d = a.indexOf(c + "=");
    return 0 <= d && 0 <= (d = a.indexOf('"', d))
      ? a.substring(d + 1, a.indexOf('"', d + 1))
      : null;
  };
  a.User = { viewUpdatedCallback: null };
  a.View = { count: 0, applets: {}, sets: {} };
  (function (b) {
    ...
    b.updateView = function (c, d) {
      if (null != c._viewSet) {
        ...
        d.data || (d.data = "N/A");
        d.type = c._viewType;
        if (null == (c._currentView = b.__findView(c._viewSet, d)))
          c._currentView = b.__createViewSet(
            c._viewSet,
            d.chemID,
            d.viewID || d.chemID
          );
        ...
        a.User.viewUpdatedCallback &&
          a.User.viewUpdatedCallback(c, "updateView");
        b.__setView(c._currentView, c, !1);
      }
    };
    b.updateFromSync = function (c, d) {
      c._updateMsg = d;
      var e = a._getAttr(d, "sourceID") || a._getAttr(d, "file");
      if (e) {
        var j = b.__findView(c._viewSet, { viewID: e });
        if (null == j) return a.updateView(c, d);
        j != c._currentView && b.__setView(j, c, !0);
        var h =
          (e = a._getAttr(d, "atoms")) && 0 <= d.indexOf("selectionhalos ON")
            ? eval("[" + e + "]")
            : [];
        setTimeout(function () {
        ...
        a.User.viewUpdatedCallback &&
          a.User.viewUpdatedCallback(c, "updateFromSync");
      }
    };
    b.updateAtomPick = function (b, d) {
      ...
      if (null != e) {
        for (var j in e)
          "info" != j && e[j].applet != b && e[j].applet._updateAtomPick(d);
        a.User.viewUpdatedCallback &&
          a.User.viewUpdatedCallback(b, "updateAtomPick");
      }
    };
      ...
      if (d) {
        ...
        for (var j in a)
          e +=
            ...
            a[j]._id +
            " currentView=" +
            (a[j]._currentView ? a[j]._currentView.info.viewID : null);
        for (j = d.length; 0 <= --j; ) {
          a = d[j];
          var e =
              e +
          ...
          for (l in a)
            "info" != l &&
              (e +=
                ...
                l +
                " applet=" +
                ((h = a[l]).applet ? h.applet._id : null) +
                " SMILES=" +
                h.smiles +
                "\n atomMap=" +
                JSON.stringify(h.atomMap) +
                "\n data=\n" +
                h.data +
                "\n");
        }
    ...
    b.__createViewSet = function (c, d, e) {
      b.count++;
      d = { info: { chemID: d, viewID: e || "model_" + b.count } };
      for (var j in a._applets)
        (e = a._applets[j]),
          e._viewSet == c && (d[e._viewType] = { applet: e, data: null });
      b.sets[c].push(d);
      return d;
    };
  ...
  a.Cache.setDragDrop = function (b, c) {
    ...
    a.$appEvent(b, c, "drop", function (d) {
      ...
      e.stopPropagation();
      e.preventDefault();
      var j = e.dataTransfer.files[0];
      if (null == j)
        try {
          (j = "" + e.dataTransfer.getData("text")),
            (0 == j.indexOf("file:/") ||
              0 == j.indexOf("http:/") ||
              0 == j.indexOf("https:/")) &&
              b._scriptLoad(j);
        ...
        (e = new FileReader()),
          (e.onloadend = function (e) {
            if (e.target.readyState == FileReader.DONE) {
              var h = "cache://DROP_" + j.name;
              e = Clazz.newByteArray(-1, e.target.result);
              if ("console_input" == c)
                (h = String.instantialize(e)),
                  a
                    .$(b, c)
                    .val(0 > h.indexOf("\x00") ? h : e.length + " bytes");
              else {
                h.endsWith(".spt") ||
                  b._appletPanel.cacheFileByName("cache://DROP_*", !1);
                "JSV" == b._viewType || h.endsWith(".jdx")
                  ? a.Cache.put(h, e)
                  : b._appletPanel.cachePut(h, e);
                e = a._jsGetXY(b._canvas, d);
                var l = [null];
                e &&
                  (!b._appletPanel.setStatusDragDropped ||
                    b._appletPanel.setStatusDragDropped(0, e[0], e[1], h, l)) &&
                  b._appletPanel.openFileAsyncSpecialType(h, 1, l[0]);
              }
            }
          }),
...
(function (a) {
    ...
    u = function (b) {
      m
        ...
        : ((m = !0),
          ...
          (LoadClazz = null),
          b.__Info.uncompressed && Clazz.loadClass(),
          (Clazz._Loader.onGlobalLoaded = function () {
    ...
    if (!(0 <= j.join("").indexOf(b))) {
      ...
      if (e && (e = e.split(" ")))
        for (b = 0; b < e.length; b++)
          0 > t.join("").indexOf(e[b]) &&
            t.push(d + "/core/core" + e[b] + ".z.js");
  ...
  a._Canvas2D = function (b, d, e, j) {
    ...
    this._isLayered = d._isLayered || !1;
  ...
  a._setAppletParams = function (b, d, e, j) {
    for (var h in e)
      if (!b || 0 <= b.indexOf(";" + h.toLowerCase() + ";"))
        null == e[h] ||
          ("language" == h && !a.featureDetection.supportsLocalization()) ||
          (j
            ? d.put(
                h,
                !0 === e[h] ? Boolean.TRUE : !1 === e[h] ? Boolean.FALSE : e[h]
              )
            : (d[h] = e[h]));
  };
  a._jsSetPrototype = function (b) {
    ...
    b._createCanvas = function (b, c, e) {
      ...
      this._deferApplet ||
        (a._document
          ? (a._documentWrite(e), this._newCanvas(!1), (e = ""))
          : ((this._deferApplet = !0),
            (e +=
              "<img width=0 height=0 src=. onerror=" +
              b +
              "._cover(false) >")));
    ...
    b._createCanvas2d = function () {
      ...
      try {
        b[0].removeChild(this._canvas),
          this._canvas.frontLayer && b[0].removeChild(this._canvas.frontLayer),
          this._canvas.rearLayer && b[0].removeChild(this._canvas.rearLayer),
          this._canvas.contentLayer &&
            b[0].removeChild(this._canvas.contentLayer),
          a._jsUnsetMouse(this._mouseInterface);
      } catch (c) {}
      ...
      b.append(h);
      a._$(h.id).css({ "z-index": a._getZ(this, "main") });
      if (this._isLayered) {
        ...
        this._isSwing
          ? ((b = document.createElement("div")),
            (b.id = this._id + "_swingdiv"),
            a._$(this._id + "_appletinfotablediv").append(b),
            a._$(b.id).css({
            ...
            (this._mouseInterface = h.contentLayer),
            (h.contentLayer.applet = this))
          : (this._mouseInterface = this._getLayer("front", b, e, j, !1));
    ...
    b.__startAppletJS = function (b) {
      0 == a._version.indexOf("$Date: ") &&
        (a._version =
          (a._version.substring(7) + " -").split(" -")[0] + " (JSmol/j2s)");
      ...
      a._syncedApplets.length && c.put("synccallback", "Jmol._mySyncCallback");
      ...
      try {
        ...
        System.out.println((a._isAsync ? "normal async abort from " : "") + h);
        return;
      }
    ...
    b._processEvent = function (a, b) {
      this._appletPanel.processMouseEvent(
        a,
        b[0],
        b[1],
        b[2],
    ...
    b._processKeyEvent = function (a, b, c) {
      this._appletPanel.processKeyEvent({
        getID: function () {
          return a;
        },
        getKeyCode: function () {
  ...
  a.repaint = function (b, e) {
    if (b && b._appletPanel) {
      ...
      if (b._is2D && (b._canvas.width != h || b._canvas.height != j))
        b._newCanvas(!0), b._appletPanel.setDisplay(b._canvas);
      b._appletPanel.setScreenDimension(h, j);
      h = function () {
        b._appletPanel.paint
          ? b._appletPanel.paint(null)
          : b._appletPanel.update(null);
      };
  ...
  a.loadImage = function (b, e, j, h, l, t) {
    ...
    if (null == s) {
      if (null == t) {
        ...
        System.out.println("Jsmol.js Jmol.loadImage using data URI for " + m);
        t.src =
          "string" == typeof h
            ? h
            : "data:" +
              JU.Rdr.guessMimeTypeForBytes(h) +
              ";base64," +
              JU.Base64.getBase64(h);
      }
      var u = t.width,
        V = t.height;
      "webgl" == e && ((u /= 2), (V /= 2));
      s = a.getHiddenCanvas(b.vwr.html5Applet, m, u, V, !0, !1);
      s.imageWidth = u;
      s.imageHeight = V;
      s.id = m;
      s.image = t;
      a.setCanvasImage(s, u, V);
    } else
      System.out.println(
        "Jsmol.js Jmol.loadImage reading cached image for " + m
      );
  ...
  a.getHiddenCanvas = function (b, e, j, h, l, t) {
    ...
    b = a._canvasCache[e];
    if (t) return b;
    if (l || !b || b.width != j || b.height != h)
      (b = document.createElement("canvas")),
        (b.width = b.style.width = j),
        (b.height = b.style.height = h),
        (b.id = e),
        (a._canvasCache[e] = b);
    return b;
  };
...
(function (a, m) {
  a._Applet = function (e, j, h) {
    ...
    this._initialize = function (e, h) {
      ...
      if (this._jarFile) {
        ...
        0 <= c.indexOf("/")
          ? (alert(
              "This web page URL is requesting that the applet used be " +
                c +
                ". This is a possible security risk, particularly if the applet is signed, because signed applets can read and write files on your local machine or network."
            ),
            "yes" ==
            prompt("Do you want to use applet " + c + "? ", "yes or no")
              ? ((e = c.substring(0, c.lastIndexOf("/"))),
                (h = c.substring(c.lastIndexOf("/") + 1)))
              : (b = !0))
          : (h = c);
        this_isSigned = j.isSigned = 0 <= h.indexOf("Signed");
      }
      this._jarPath = j.jarPath = e || ".";
      this._jarFile = j.jarFile =
        "string" == typeof h
          ? h
          : (h ? "JmolAppletSigned" : "JmolApplet") + "0.jar";
      b &&
        alert(
          "The web page URL was ignored. Continuing using " +
            this._jarFile +
            ' in directory "' +
            this._jarPath +
            '"'
  ...
  l._get = function (e, j, h) {
    ...
    a._debugAlert = j.debug;
    j.serverURL && (a._serverUrl = j.serverURL);
    for (
      var m = !1,
        u = null,
        b = j.use.toUpperCase().split("#")[0].split(" "),
        c = 0;
      c < b.length;
      c++
    ) {
      switch (b[c]) {
        ...
        case "WEBGL":
          ...
          break;
        case "HTML5":
          a.featureDetection.allowHTML5
            ? (u = l._getCanvas(e, j, h, !1))
            : b.push("JAVA");
      }
      if (null != u) break;
    }
    null == u &&
      (h || !m ? (u = { _jmolType: "none" }) : m && (u = new l(e, j)));
    return h ? u : a._registerApplet(e, u);
  };
  l._getCanvas = function (e, j, h, m) {
    j._isLayered = !1;
    j._platform = "J.awtjs2d.Platform";
    return m && a.featureDetection.supportsWebGL()
      ? ((a._Canvas3D.prototype = a.GLmol.extendApplet(
          a._jsSetPrototype(new l(e, j, !0))
        )),
        new a._Canvas3D(e, j, "Jmol", h))
      : !m
      ? ((a._Canvas2D.prototype = a._jsSetPrototype(new l(e, j, !0))),
        new a._Canvas2D(e, j, "Jmol", h))
      : null;
  };
  l._noJavaMsg =
    "Either you do not have Java applets enabled in your web<br />browser or your browser is blocking this applet.<br />\t\t\tCheck the warning message from your browser and/or enable Java applets in<br />\t\t\tyour web browser preferences, or install the Java Runtime Environment from <a href='http://www.java.com'>www.java.com</a>";
  ...
  l._createApplet = function (e, j, h) {
    ...
    h.mayscript = "true";
    h.java_arguments =
      "-Xmx" + Math.round(j.memoryLimit || e._memoryLimit) + "m";
    ...
    var c = "\n",
      d;
    for (d in h)
      h[d] && (c += "  <param name='" + d + "' value='" + h[d] + "' />\n");
    c =
      a.featureDetection.useIEObject || a.featureDetection.useHtml4Object
        ? "<object " +
          b +
          (a.featureDetection.useIEObject
    ...
    c =
      ...
      c +
      a._getWrapper(e, !1) +
      (j.addSelectionOptions ? a._getGrabberOptions(e) : "");
  ...
  h._newApplet = function (a) {
    this._is2D ||
      a.put(
        "script",
        (a.get("script") || "") + ";set multipleBondSpacing 0.35;"
      );
  ...
  h._addCoreFiles = function () {
    a._addCoreFile(
      "jmol" + (a._debugCode ? "debug" : ""),
      this._j2sPath,
      this.__Info.preloadCore
    );
    a._debugCode &&
      a._addCoreFile("jmoldebug", this._j2sPath, this.__Info.preloadCore);
    this._is2D ||
      a._addExec([this, null, "J.export.JSExporter", "load JSExporter"]);
    ...
    j.inlineModel
      ? ((m = j.inlineModel),
        (m = m
          .replace(/\r|\n|\r\n/g, 0 <= m.indexOf("|") ? "\\/n" : "|")
          .replace(/'/g, "&#39;")),
        a._debugAlert && alert("inline model:\n" + m))
      : (m = "");
    h.loadInline = m;
    h.appletReadyCallback = "Jmol._readyCallback";
    a._syncedApplets.length && (h.synccallback = "Jmol._mySyncCallback");
    h.java_arguments =
      "-Xmx" + Math.round(j.memoryLimit || this._memoryLimit) + "m";
    this._initialize(j.jarPath, j.jarFile);
    ...
    switch (j) {
      ...
      default:
        ...
        if (l && l.isScriptExecuting && l.isScriptExecuting()) {
          if (a._asyncCallbacks[e]) return System.out.println("...ignored"), 1;
  ...
  h._readyCallback = function (e, j, h) {
    if (h) {
      ...
      e = this._readyScript;
      this._defaultModel
        ? a._search(this, this._defaultModel, e ? ";" + e : "")
        : e
        ? this._script(e)
        : this._src && this._script('load "' + this._src + '"');
      this._showInfo(!0);
      this._showInfo(!1);
      a.Cache.setDragDrop(this, "appletdiv");
      this._readyFunction && this._readyFunction(this);
      a._setReady(this);
      if ((e = this._2dapplet) && e._isEmbedded && e._ready && e.__Info.visible)
        this._show2d(!0), this._show2d(!1), this._show2d(!0);
  ...
  h._show2d = function (a) {
    ...
    this._2dapplet._isEmbedded &&
      (this._showInfo(!1),
      this._show(!a),
      this._2dapplet.__showContainer(!0, !0));
  };
  h._getSpinner = function () {
    return (
      this.__Info.appletLoadingImage || this._j2sPath + "/img/JSmol_spinner.gif"
    );
  };
  h._getAtomCorrelation = function (a, j) {
    ...
    if (0 != h) {
      this._loadMolData(
        a,
        "atommap = compare({1.1} {2.1} 'MAP' " +
          (j ? "" : "'H'") +
          "); zap 2.1",
        !0
      );
      for (
        var l = this._evaluate("atommap"), m = [], b = [], c = 0;
        c < l.length;
        c++
      ) {
        var d = l[c];
  ...
  h._setCallback = function (a, j) {
    this._applet.setCallback(a, j);
  };
  ...
  h._scriptEcho = function (a) {
    ...
    for (var h = "", l = a.length; 0 <= --l; )
      for (var m = a[l].length; 0 <= --m; )
        "scriptEcho" == a[l][m][1] && (h += a[l][m][3] + "\n");
    return h.replace(/ \| /g, "\n");
  };
  h._scriptMessage = function (a) {
    ...
    for (var h = "", l = a.length; 0 <= --l; )
      for (var m = a[l].length; 0 <= --m; )
        "scriptStatus" == a[l][m][1] && (h += a[l][m][3] + "\n");
    return h.replace(/ \| /g, "\n");
  };
  ...
  h._scriptWaitAsArray = function (e) {
    ...
    try {
      if (
        ...
        e &&
          ((h += this._applet.scriptWait(e)),
          (h = a._evalJSON(h, "jmolStatus")),
          "object" == typeof h))
      )
        return h;
    } catch (l) {}
  ...
  h._getPropertyAsJavaObject = function (a, h) {
    void 0 == h && (h = "");
  ...
  h._saveOrientation = function (a) {
    return (this._savedOrientations[a] = this._getPropertyAsArray(
      "orientationInfo",
      "info"
    ).moveTo);
  };
  ...
  h._resizeApplet = function (e) {
    function h(e, j) {
      ...
      return 0 == b.length
        ? j
          ? ""
          : a._allowedJmolSize[2]
        : b.indexOf("%") == b.length - 1
        ? b
        : 1 >= (e = parseFloat(e)) && 0 < e
        ? 100 * e + "%"
        : (isNaN((e = Math.floor(e)))
            ? a._allowedJmolSize[2]
            : e < a._allowedJmolSize[0]
            ? a._allowedJmolSize[0]
            : e > a._allowedJmolSize[1]
            ? a._allowedJmolSize[1]
            : e) + (j ? j : "");
    }
    var l;
    "object" == typeof e && null != e
      ? ((l = e[0] || e.width), (e = e[1] || e.height))
      : (l = e);
    l = [h(l, "px"), h(e, "px")];
  ...
  h._searchDatabase = function (e, h, l) {
    if (
      this._2dapplet &&
      this._2dapplet._isEmbedded &&
      !a.$(this, "appletdiv:visible")[0]
    )
      return this._2dapplet._searchDatabase(e, h, l);
    this._showInfo(!1);
    0 <= e.indexOf("?")
      ? a._getInfoFromDatabase(this, h, e.split("?")[0])
      : (l || (l = a._getScriptForDatabase(h)),
        (e = h + e),
        (this._currentView = null),
        (this._searchQuery = e),
        this._loadFile(e, l, e));
  };
  ...
  h.__loadModel = function (e, h, l) {
    null != e &&
      (null != this._viewSet &&
        (h || (h = ""),
        (h +=
          ";if ({*}.molecule.max > 1 || {*}.modelindex.max > 0){ delete molecule > 1 or modelindex > 0;x = getProperty('extractModel',{*});load inline @x};")),
      !h && this._noscript
        ? this._applet.loadInlineString(e, "", !1)
        : this._loadMolData(e, h, !1),
      null != this._viewSet && a.View.updateView(this, { chemID: l, data: e }));
  };
  h._loadMolData = function (a, h, l) {
    h || (h = "");
    l = l ? "append" : "model";
    this._applet.scriptWait(
      'load DATA "' + l + '"' + a + '\nEND "' + l + '" ;' + h
    );
  };
  h._loadModelFromView = function (e) {
    ...
    var h = e.Jmol;
    null != h.data
      ? this.__loadModel(h.data, null, e.info.chemID)
      : null != e.info.chemID
      ? a._searchMol(this, e.info.chemID, null, !1)
      : (h = e.JME) && h.applet._show2d(!1, this);
  };
  h._reset = function () {
  ...
  h._updateView = function () {
    null != this._viewSet &&
      ...
      ((chemID =
        "" +
        this._getPropertyAsJavaObject(
          "variableInfo",
          "script('show chemical inchiKey')"
        )),
      (chemID =
        36 > chemID.length ? null : chemID.substring(36).split("\n")[0]),
      a.View.updateView(this, {
        chemID: chemID,
        data:
          "" +
          this._getPropertyAsJavaObject(
  ...
  h._updateAtomPick = function (a) {
    this._script(
      0 == a.length
        ? "select none"
        : "select on visible and (@" + a.join(",@") + ")"
    );
  };
  ...
  h._checkDeferred = function (a) {
    return this._isDeferred()
      ? ((this._coverScript = a), this._cover(!1), !0)
      : !1;
  };
  h._cover = function (e) {
    e || !this._deferApplet
      ? this._displayCoverImage(e)
      : ((e = this._coverScript ? this._coverScript : ""),
        (this._coverScript = ""),
        this._deferUncover &&
          (e +=
            ";refresh;javascript " + this._id + "._displayCoverImage(false)"),
        this._script(e, !0),
        this._deferUncover &&
          "activate 3D model" == this._coverTitle &&
          (a._getElement(this, "coverimage").title = "3D model is loading..."),
        this._isJava || this._newCanvas(!1),
        this._defaultModel && a._search(this, this._defaultModel),
        this._showInfo(!1),
        this._deferUncover || this._displayCoverImage(!1),
        this._isJava && a.$html(a.$(this, "appletdiv"), this._javaCode),
  ...
  h._displayCoverImage = function (e) {
    this._coverImage &&
      this._isCovered != e &&
      ((this._isCovered = e),
      (a._getElement(this, "coverdiv").style.display = e ? "block" : "none"));
  };
...
(function (a) {
  ...
  m._radio = function (a, h, e, j, t, s, u, b) {
    ...
    h =
      ...
      "' id='" +
      u +
      "' type='radio' onclick='Jmol.controls._click(this);return true;' onmouseover='Jmol.controls._mouseOver(this);return true;' onmouseout='Jmol.controls._mouseOut()' " +
      (j ? "checked='true' " : "") +
      m._radioCssText +
      " />";
  ...
  m._scriptExecute = function (l, h) {
    var e = a._applets[h[0]],
      j = h[1];
    if ("object" == typeof j) j[0](l, j, e);
    else "function" == typeof j ? j(e) : a.script(e, j);
  };
  m.__checkScript = function (a, h) {
    var e =
      0 <= h.value.indexOf("JSCONSOLE ") || "" === a._scriptCheck(h.value);
  ...
  m.__getCmd = function (a, h) {
    if (h._cmds && h._cmds.length) {
      var e =
        h._cmds[(h._cmdpt = (h._cmdpt + h._cmds.length + a) % h._cmds.length)];
      setTimeout(function () {
        h.value = e;
      }, 10);
      h._cmdadd = 1;
  ...
  m._commandKeyPress = function (l, h, e) {
    ...
    switch (l) {
      case 13:
        return (
          (h = j.value),
          m._scriptExecute(j, [e, h]),
          j._cmds ||
            ((j._cmds = []), (j._cmddir = 0), (j._cmdpt = -1), (j._cmdadd = 0)),
          h && 0 == j._cmdadd
            ? (++j._cmdpt,
              j._cmds.splice(j._cmdpt, 0, h),
              (j._cmdadd = 0),
              (j._cmddir = 0))
            : (j._cmdadd = 0),
          (j.value = ""),
  ...
  m._cbNotifyMaster = function (a) {
    ...
    (a = m._checkboxItems[t.id]) &&
      (t = a.chkMaster) &&
      m._cbNotifyMaster(m._checkboxMasters[t.id]);
  };
  ...
  m._cbSetCheckboxGroup = function (a, h, e) {
    ...
    (a = document.getElementById(j)) ||
      alert("jmolSetCheckboxGroup: master checkbox not found: " + j);
    var t = (m._checkboxMasters[j] = {});
    t.chkMaster = a;
    t.chkGroup = {};
    "string" == typeof h ? ((h = e), (j = 1)) : (j = 0);
    for (a = j; a < h.length; a++)
      (j = h[a]),
        "number" == typeof j && (j = "jmolCheckbox" + j),
        (e = document.getElementById(j)) ||
          alert("jmolSetCheckboxGroup: group checkbox not found: " + j),
        (t.chkGroup[j] = e),
        (m._checkboxItems[j] = t);
  };
  m._cbClick = function (a) {
    ...
    m._checkboxMasters[a.id] &&
      m._cbNotifyGroup(m._checkboxMasters[a.id], a.checked);
  ...
  m._onloadResetForms = function () {
    m._hasResetForms ||
      ((m._hasResetForms = !0),
      (m._previousOnloadHandler = window.onload),
  ...
  m._getCheckbox = function (l, h, e, j, t, s, u) {
    ...
    ++m._checkboxCount;
    if (void 0 == h || null == h || void 0 == e || null == e)
      alert("jmolCheckbox requires two scripts");
    else if (void 0 == j || null == j) alert("jmolCheckbox requires a label");
    else
      return (
        (m._actions[s] = [m._addScript(b, h), m._addScript(b, e)]),
        (l = "</span>"),
        (t =
          '<span id="span_' +
          s +
          ...
          "' id='" +
          s +
          "' onclick='Jmol.controls._cbClick(this)' onmouseover='Jmol.controls._cbOver(this);return true' onmouseout='Jmol.controls._mouseOut()' " +
          (t ? "checked='true' " : "") +
          m._checkboxCssText +
          " />"),
        0 <= j.toLowerCase().indexOf("<td>") && ((t += l), (l = "")),
        (t += '<label for="' + s + '">' + j + "</label>" + l),
        a._debugAlert && alert(t),
        a._documentWrite(t)
      );
  };
  m._getCommandInput = function (l, h, e, j, t, s) {
    ...
    h =
      ...
      "' size='" +
      e +
      "' onkeydown='return Jmol.controls._commandKeyPress(event,\"" +
      j +
      '","' +
      l +
      "\")' value='" +
      ...
      "Btn' value = '" +
      h +
      "' onclick='Jmol.controls._commandKeyPress(13,\"" +
      j +
      '","' +
      l +
      "\")' /></span>";
  ...
  m._getLink = function (l, h, e, j, t) {
    ...
    e =
      ...
      "' id='" +
      j +
      "' href='javascript:Jmol.controls._click(null," +
      h +
      ");' onmouseover='Jmol.controls._mouseOver(null," +
      h +
...
(function (a) {
  var m = function (a) {
    a = "&" + a + "=";
    return decodeURI(
      ("&" + document.location.search.substring(1) + a)
        .split(a)[1]
        .split("&")[0]
    );
  };
  ...
  a.script = function (a, h) {
    a._checkDeferred(h) || a._script(h);
  };
  ...
  a.jmolRadio = function (l, h, e, j, m, s, u, b) {
    return a.controls._getRadio(l, h, e, j, m, s, u, b);
  };
  ...
  a.setXHTML = function (l) {
    ...
    a._XhtmlAppendChild = !1;
    l &&
      ((a._XhtmlElement = document.getElementById(l)),
      (a._XhtmlAppendChild = !0));
  };
  a.setAppletCss = function (l, h) {
    null != l && (a._appletCssClass = l);
    a._appletCssText = h ? h + " " : l ? 'class="' + l + '" ' : "";
  };
  a.setButtonCss = function (l, h) {
  ...
  a.setMenuCss = function (l, h) {
    null != l && (a.controls._menuCssClass = l);
...
LoadClazz = function () {
  TypeError.prototype.printStackTrace =
    ReferenceError.prototype.printStackTrace = function () {
      console.log(this);
    };
  c$ = null;
  window["j2s.clazzloaded"] || (window["j2s.clazzloaded"] = !1);
  window["j2s.clazzloaded"] ||
    ((window["j2s.clazzloaded"] = !0),
    (window["j2s.object.native"] = !0),
    (Clazz = { _isQuiet: !1, _debugging: !1 }),
    (function (a, m) {
      try {
      ...
      a.setConsoleDiv = function (a) {
        window["j2s.lib"] && (window["j2s.lib"].console = a);
      };
      var e = null;
      ...
      a._supportsNativeObject
        ? ((a._O = function () {}),
          (a._O.__CLASS_NAME__ = "Object"),
          (a._O.getClass = function () {
            return a._O;
          }))
        : (a._O = Object);
      a.Console = {};
      ...
      j.toString = function () {
        return this.__CLASS_NAME__
          ? "[" + this.__CLASS_NAME__ + " object]"
          : this.to$tring.apply(this, arguments);
      };
      a._extendedObjectMethods =
        "equals hashCode getClass clone finalize notify notifyAll wait to$tring toString".split(
          " "
        );
        ...
        if (b instanceof a.CastedNull) b = b.clazzName;
          ...
          switch (typeof b) {
            case "string":
              return String;
            case "object":
              if (!b.__CLASS_NAME__) return b.constructor || a._O;
              b = b.__CLASS_NAME__;
              break;
            default:
      ...
      var t = function (b, c) {
          for (var d = 0; d < a.innerFunctionNames.length; d++)
            if (c == a.innerFunctionNames[d] && a._innerFunctions[c] === b[c])
              return !0;
          return !1;
        },
        s = function () {};
      ...
      a.inheritClass = function (b, c, d) {
        for (var e in c)
          "b$" != e &&
            ...
            !t(c, e) &&
            (b[e] = c[e]);
        a.unloadedClasses[a.getClassName(b, !0)] ||
          (b.prototype = d
            ? d
            : c !== Number
            ? new c(a.inheritArgs)
        ...
        if (2 <= arguments.length) {
          ...
          if (2 == arguments.length)
            ...
            for (d = 1; d < arguments.length; d++)
              c.push(arguments[d]), u(a, arguments[d]);
        }
      };
      var u = function (a, b) {
        for (var c in b)
          if (
            ...
            "__CLASS_NAME__" != c &&
            "implementz" != c &&
            ("function" != typeof b[c] || !t(b, c))
          )
            a[c] = a.prototype[c] = b[c];
      };
      ...
      a.instanceOf = function (b, c) {
        return (
          ...
          (b == c ||
            b instanceof c ||
            0 <= a.getInheritedLevel(a.getClassName(b), c))
        );
      };
      a.superCall = function (b, c, d, e) {
        ...
        if (l)
          if (l.claxxOwner) l.claxxOwner !== c && (h = l);
            ...
            !l.stacks &&
            (!l.lastClaxxRef ||
              !l.lastClaxxRef.prototype[d] ||
              !l.lastClaxxRef.prototype[d].stacks)
          )
            h = l;
          else {
            var m = l.stacks;
            ...
            for (j = m.length; 0 <= --j; )
              if (c === m[j]) {
                h =
                  0 < j ? m[--j].prototype[d] : m[0].prototype[d]["\\unknown"];
                break;
        ...
        if (h)
          return (
            0 == j &&
              ...
              !c[0].superClazz &&
              c[0].con$truct &&
              c[0].con$truct.apply(b, []),
            h.apply(b, e || [])
          );
        "construct" != d &&
          (a.alert(["j2slib", "no class found", e.typeString]),
          fb(b, c, d, a.getParamsType(e).typeString));
      };
      ...
      try {
        ...
        if (
          ...
          var j = d.message.indexOf(":"),
            ...
            K = d.message.substr(j + 1, q - j - 20);
          c = function (a) {
            return -1 != a.message.indexOf(K);
          };
        } else if (-1 != navigator.userAgent.toLowerCase().indexOf("webkit")) {
          var U = j(d.message, "hello");
          c = function (a) {
            return U.test(a.message);
          };
        } else
          (U = j(d.message, "$$o$$")),
            (c = function (a) {
      ...
      a.getStackTrace = function (a) {
        ...
        try {
          for (var e = 0; e < a && (c = c.caller); e++) {
            var h = c.toString
                ? c.toString().substring(0, c.toString().indexOf("{"))
                : "<native method>",
              b =
                b +
                (e +
                  " " +
                  (c.exName
                    ? (c.claxxOwner ? c.claxxOwner.__CLASS_NAME__ + "." : "") +
                      c.exName +
                      h.replace(/function /, "")
                    : h) +
                  "\n");
      ...
      a.defineMethod = function (c, d, h, j) {
        ...
        var l = c.prototype,
          m = l[d];
        a._Loader._checkLoad && C(c, d, j);
        if (!m || (m.claxxOwner === c && m.funParams == j))
          return (
            (h.funParams = j), (h.claxxOwner = c), (h.exClazz = c), (l[d] = h)
          );
        var s = null,
          q = m.stacks;
        q || ((q = []), (s = m), m.claxxOwner && (q[0] = s.claxxOwner));
              ...
              if (fx.lastParams == h.typeString && fx.lastClaxxRef === d) {
                if (h.hasCastedNull) {
                  ...
                  for (k = 0; k < c.length; k++)
                    d[k] = c[k] instanceof a.CastedNull ? null : c[k];
                } else d = c;
                ...
                for (var r = !1, l = j.length; 0 <= --l; )
                  if (r || j[l] === d) {
                    var m = j[l].prototype[k],
                      ...
                      E = void 0;
                    for (E in m)
                      if (92 == E.charCodeAt(0)) {
                        var u = E.substring(1).split("\\");
                        u.length == z.length && q.push(u);
                        t = !1;
                      } else if (t && "funParams" == E && m.funParams) {
                        E = m.funParams;
                        u = E.substring(1).split("\\");
                    ...
                    if (!(E = 0 == q.length)) {
                      E = void 0;
                      for (var E = [], N = q.length, u = 0; u < N; u++) {
                        for (
                          var x = [], xa = !0, C = q[u].length, B = 0;
                          B < C;
                          B++
                        )
                          if (
                            ((x[B] = a.getInheritedLevel(z[B], q[u][B])),
                            0 > x[B])
                          ) {
                            xa = !1;
                            break;
                          }
                        xa && ((x[z.length] = u), E.push(x));
                      }
                      if (0 == E.length) E = null;
                      else {
                        N = E[0];
                    ...
                    if (E) r = new b();
                      ...
                      if (z.hasCastedNull) {
                        ...
                        for (z = 0; z < r.length; z++)
                          t[z] = r[z] instanceof a.CastedNull ? null : r[z];
                      } else t = r;
                      s.lastMethod = m;
                      r = m.apply(this, t);
                    }
      ...
      var C = function (b, c, d) {
        var e = b.prototype[c];
        if (e && (e.claxxOwner || e.claxxReference) === b)
          (key = b.__CLASS_NAME__ + "." + c + d),
            (b = duplicatedMethods[key])
              ? ((c = "Warning! Duplicate method found for " + key),
                System.out.println(c),
                a.alert(c),
                (duplicatedMethods[key] = b + 1))
      ...
      var rb = function (a, b) {
          if (a && b)
            for (var c = a.length; 0 <= --c; ) if (a[c] === b) return c;
          return -1;
        },
        Ya = function (a, b) {
          var c = rb(a, b);
      ...
      a.getParamsType = function (b) {
        ...
        if (b)
          for (var e = 0; e < c; e++)
            (d[e] = a.getClassName(b[e])),
              b[e] instanceof a.CastedNull && (d.hasCastedNull = !0);
        d.typeString = "\\" + d.join("\\");
        return d;
      };
      var O = 0;
      ...
      a.declarePackage = function (b) {
        ...
        if (b && b.length) {
          for (
            var c = b.split(/\./), d = a.allPackage, e = 0;
            e < c.length;
            e++
          )
            d[c[e]] ||
      ...
      -1 != navigator.userAgent.indexOf("Safari") &&
        ...
        (q = j.indexOf("Version/")),
        -1 != q && ((j = j.substring(q + 8)), (Da = 4 <= parseFloat(j))));
      a.instantialize = function (a, b) {
        if (!b || !(1 == b.length && b[0] && b[0] instanceof s)) {
          ...
          (c = a.construct)
            ? a.con$truct
              ? a.getClass().superClazz
                ? (c.claxxOwner && c.claxxOwner === a.getClass()) ||
                  (c.stacks && c.stacks[c.stacks.length - 1] == a.getClass())
                  ? c.apply(a, b)
                  : (c.claxxOwner &&
                    !c.claxxOwner.superClazz &&
                    c.claxxOwner.con$truct
                      ? c.claxxOwner.con$truct.apply(a, [])
                      : c.stacks &&
                        1 == c.stacks.length &&
                        !c.stacks[0].superClazz &&
                        c.stacks[0].con$truct.apply(a, []),
                    c.apply(a, b),
                    a.con$truct.apply(a, []))
                : (a.con$truct.apply(a, []), c.apply(a, b))
              : c.apply(a, b)
            : a.con$truct && a.con$truct.apply(a, []);
        }
      };
      a.innerFunctionNames =
        "isInstance equals hashCode getName getCanonicalName getClassLoader getResource getResourceAsStream defineMethod defineStaticMethod makeConstructor".split(
          " "
        );
      a._innerFunctions = {
        ...
        getResourceAsStream: function (b) {
          ...
          if (0 == b.indexOf("/"))
            if (
              (2 == arguments.length
                ? (c = arguments[1]) || (c = a.binaryFolders[0])
                : a._Loader && (c = a._Loader.getClasspathFor(d, !0)),
              c)
            ) {
              var c = c.replace(/\\/g, "/"),
                e = c.length,
            ...
            if (this.base) c = this.base;
              ...
              if (
                ((c = a._Loader.getClasspathFor(d)),
                (e = c.lastIndexOf(d.replace(/\./g, "/"))),
                -1 != e)
              )
                c = c.substring(0, e);
              else if (
                ((e = -1),
                c.indexOf(".z.js") == c.length - 5 &&
                  -1 != (e = c.lastIndexOf("/")))
              )
                for (
                  var c = c.substring(0, e + 1), e = d.split(/\./), h = 1;
                  h < e.length;
                  h++
                ) {
            ...
            this.base
              ...
              : ((e = d.lastIndexOf(".")),
                (d =
                  -1 == e || this.base
                    ? c + b
                    : c + d.substring(0, e).replace(/\./g, "/") + "/" + b));
          }
          c = null;
          try {
            if (0 > d.indexOf(":/")) {
              var q = document.location.href.split("?")[0].split("/");
              q[q.length - 1] = d;
              d = q.join("/");
            }
          ...
          q = new java.io.BufferedInputStream(
            new java.io.ByteArrayInputStream(q)
          );
          q.url = c;
          return q;
        },
      ...
      a.decorateAsClass = function (b, c, d, e, h, j) {
        ...
        var m = (l ? l + "." : "") + d;
        a._Loader._classPending[m] &&
          (delete a._Loader._classPending[m],
          a._Loader._classCountOK++,
          a._Loader._classCountPending--);
        a._Loader &&
          a._Loader._checkLoad &&
          System.out.println("decorating class " + l + "." + d);
        (l = a.unloadedClasses[m]) && (b = l);
        db(b, c, d);
        j ? a.inheritClass(b, e, j) : e && a.inheritClass(b, e);
        h && a.implementOf(b, h);
        return b;
      };
      var db = function (b, c, d) {
        ...
        c
          ? c.__PKG_NAME__
            ? ((e = c.__PKG_NAME__ + "." + d),
              (c[d] = b),
              c === java.lang && a.setGlobal(d, b))
            : ((e = c.__CLASS_NAME__ + "." + d), (c[d] = b))
          : ((e = d), a.setGlobal(d, b));
        a.extendJO(b, e);
      ...
      a.declareType = function (b, c, d, e, h) {
        return a.decorateAsClass(
          function () {
      ...
      a.decorateAsType = function (b, c, d, e, h, j) {
        ...
        if (j)
          for (c = 0; c < a.innerFunctionNames.length; c++)
            (j = a.innerFunctionNames[c]), (b[j] = a._innerFunctions[j]);
        h ? a.inheritClass(b, d, h) : d && a.inheritClass(b, d);
        e && a.implementOf(b, e);
        return b;
      };
      ...
      java.lang.ClassLoader = { __CLASS_NAME__: "ClassLoader" };
      var fb = function (b, c, d, e) {
        b = "";
        e && (b = e.substring(1).replace(/\\/g, ","));
        c =
          (d && "construct" != d ? "Method" : "Constructor") +
          " " +
          a.getClassName(c, !0) +
          "." +
          d +
      ...
      a.prepareCallback = function (b, c) {
        ...
        if (b && d && d !== window) {
          var e = a.getClassName(d, !0),
            h = {};
          if (b.b$) for (var j in b.b$) h[j] = b.b$[j];
          b.b$ = h;
          h[e] = d;
          for (e = a.getClass(d); e.superClazz; )
            (e = e.superClazz), (h[a.getClassName(e, !0)] = d);
          if ((d = d.b$)) for (j in d) h[j] = d[j];
        }
        for (h = 0; h < c.length - 1; h++) c[h] = c[h + 1];
        0 < c.length && c.length--;
      };
        ...
        if (d || c.$finals)
          ...
          switch (arguments.length) {
            case 3:
              return new b(c);
            case 4:
              return c.__CLASS_NAME__ == b.__CLASS_NAME__ &&
                arguments[3] === a.inheritArgs
                ? c
                : new b(c, arguments[3]);
            case 5:
              return new b(c, arguments[3], arguments[4]);
            case 6:
              return new b(c, arguments[3], arguments[4], arguments[5]);
            case 7:
              return new b(
                c,
                arguments[3],
      ...
      a.cloneFinals = function () {
        for (var a = {}, b = arguments.length / 2; 0 <= --b; )
          a[arguments[b + b]] = arguments[b + b + 1];
        return a;
      };
      ...
      var gb = function (a, b) {
          ...
          else for (var c = Array(a), d = 0; d < a; d++) c[d] = 0;
      ...
      !0 ==
      (a.haveFloat64 = !!(self.Float64Array && self.Float64Array != Array))
        ? Float64Array.prototype.sort ||
          (Float64Array.prototype.sort = Array.prototype.sort)
        : ((Float64Array = function (a) {
            return gb(a, 64);
          }),
          (Float64Array.prototype.sort = Array.prototype.sort),
      ...
      a.newArray = function (a, b, c, d) {
        if (-1 != a || 2 == arguments.length) return la(arguments, 0);
        a = b.slice(c, d);
      ...
      var la = function (a, b) {
        ...
        var d = a.length - 1,
          e = a[d];
        if (1 < d) {
          for (var e = Array(d), h = 0; h < d; h++) e[h] = a[h + 1];
          d = Array(c);
          for (h = 0; h < c; h++) d[h] = la(e, b);
          return d;
        }
        0 < b && 0 > c && (c = e);
        switch (b) {
      ...
      a.isAB = function (a) {
        return a && "object" == typeof a && 1 == a.BYTES_PER_ELEMENT;
      };
      a.isAI = function (a) {
      ...
      a.isAS = function (a) {
        return (
          ...
          "object" == typeof a &&
          a.constructor == Array &&
          ("string" == typeof a[0] || "undefined" == typeof a[0])
        );
      };
      a.isAII = function (b) {
      ...
      a.isASS = function (b) {
        return b && "object" == typeof b && a.isAS(b[0]);
      };
      ...
      a.prepareFields = function (a, b) {
        var c = [];
        if (a.con$truct)
          for (var d = a.con$truct.stacks, e = 0; e < d.length; e++)
            c[e] = d[e];
        d = a.con$truct = function () {
          var a = arguments.callee.stacks;
          if (a) for (var b = 0; b < a.length; b++) a[b].apply(this, []);
        };
      ...
      a.checkPrivateMethod = function () {
        ...
        me.privateNote ||
          ((me.privateNote =
            "You are seeing this note because the method " +
            me.exName +
            b +
            " in class " +
            me.exClazz.__CLASS_NAME__ +
            " has a superclass method by the same name (possibly with the same parameters) that is private and  therefore might be called improperly from this class. If your  code does not run properly, or you want to make it run faster, change the name of this method to something else."),
      ...
      a.innerFunctionNames = a.innerFunctionNames.concat(
        "getSuperclass isAssignableFrom getConstructor getDeclaredMethod getDeclaredMethods getMethod getMethods getModifiers newInstance".split(
          " "
        )
      );
      ...
      a._innerFunctions.getDeclaredMethods = a._innerFunctions.getMethods =
        function () {
          var a = [],
            b = this.prototype,
            c;
      ...
      a._innerFunctions.getDeclaredMethod = a._innerFunctions.getMethod =
        function (a) {
          var b = this.prototype,
            c;
          for (c in b)
            if (a == c && "function" == typeof b[c] && !b[c].__CLASS_NAME__)
      ...
      a._innerFunctions.newInstance = function (a) {
        switch (null == a ? 0 : a.length) {
          ...
          default:
            for (
              var b = "new " + this.__CLASS_NAME__ + "(", c = 0;
              c < a.length;
              c++
            )
              b += (0 == c ? "" : ",") + "a[" + c + "]";
      ...
      for (q = 0; q < j.length; q++)
        (a._O[j[q]] = a._innerFunctions[j[q]]),
          (Array[j[q]] = a._innerFunctions[j[q]]);
      ...
      (function (a, b) {
        ...
        b.requireLoaderByBase = function (a) {
          for (var d = 0; d < c.length; d++) if (c[d].base == a) return c[d];
          d = new b();
          d.base = a;
          c.push(d);
          return d;
              ...
              if (a[c]) {
                if ("$" == a[c].charAt(0))
                  if ("." == a[c].charAt(1)) {
                    ...
                    var d = b.lastIndexOf(".");
                    -1 != d &&
                      ((b = b.substring(0, d)), (a[c] = b + a[c].substring(1)));
          ...
          if (a instanceof Array)
            if ((C(a), e))
              ...
              for (j = 0; j < a.length; j++)
                b.loadPackageClasspath(a[j], c, d, null);
          else {
            switch (a) {
              case "java.*":
                a = "java";
        ...
        a.loadClass = function (c, d, e) {
          self.Class ||
            ((Class = a), (Class.forName = a._4Name), (JavaObject = a._O));
        ...
        b.loadClass = function (c, f, h, j, l) {
          ...
          if (
            !h &&
            ((K && c.lastIndexOf(".package") != c.length - 8) ||
              (0 != c.indexOf("java.") && !isClassDefined(ea)))
          )
            Ja.push([c, f]),
              System.out.println(
                "loadclass-queuing" + c + ea + " " + isClassDefined(ea)
              );
          else if ((l = isClassDefined(c)) || L["@" + c]) {
            if (
              l &&
              f &&
              ((h = G(c)), !h || h.status >= x.STATUS_LOAD_COMPLETE)
            )
              j ? window.setTimeout(f, 25) : f();
          } else {
            var m = b.getClasspathFor(c);
            l = e[m];
            if (!l)
              for (j = H.length; 0 <= --j; )
                if (H[j].path == m || H[j].name == c) {
                  l = !0;
                  break;
                }
            if (l) {
              ...
              l = (a.unloadedClasses[c] && G(c)) || new x();
              l.name = c;
              l.path = m;
              ...
              c = !1;
              for (j = H.length; 0 <= --j; )
                if (H[j].status != x.STATUS_LOAD_COMPLETE) {
                  c = !0;
                  break;
                }
              if (l.isPackage) {
                for (j = H.length; 0 <= --j && !H[j].isPackage; )
                  H[j + 1] = H[j];
                H[++j] = l;
              } else c && H.push(l);
              if (!c) {
        ...
        b.loadPackage = function (a, c) {
          ...
          b.loadPackageClasspath(
            a,
            b.J2SLibBase || (b.J2SLibBase = b.getJ2SLibBase() || "j2s/"),
            !0,
            c
          );
        };
        ...
        b.registerPackages = function (c, d) {
          for (
            var e = b.getClasspathFor(c + ".*", !0), f = 0;
            f < d.length;
            f++
          )
            window.Clazz && a.declarePackage(c + "." + d[f]),
              b.loadPackageClasspath(c + "." + d[f], e);
        };
          ...
          if (!f || d || e) {
            ...
            if (f) {
              if (
                ...
                0 <= (j = f.lastIndexOf(c)) ||
                  (0 <= (j = c.lastIndexOf("/")) &&
                    0 <= (j = f.lastIndexOf(c.substring(0, j)))))
              )
                h = f.substring(0, j);
            } else {
              for (
                j = c.length + 2;
                0 <= (j = c.lastIndexOf(".", j - 2)) &&
                !(h = D["@" + c.substring(0, j)]);
            ...
            null == h &&
              (h =
                window.Clazz && a.binaryFolders && a.binaryFolders.length
                  ? a.binaryFolders[0]
                  : b.binaryFolders && b.binaryFolders.length
                  ? b.binaryFolders[0]
                  : "j2s");
            f =
              (h.lastIndexOf("/") == h.length - 1 ? h : h + "/") +
              (d
                ? ""
                : c.lastIndexOf("/*") == c.length - 2
                ? c.substring(0, j + 1)
                : c + (!e ? ".js" : "." != e.charAt(0) ? "." + e : e));
          }
          return f;
        };
        b.ignore = function () {
          var a =
              1 == arguments.length && arguments[0] instanceof Array
                ? (a = arguments[0])
                : null,
            b = a ? a.length : arguments.length;
          if (!a) for (var a = Array(b), c = 0; c < b; c++) a[c] = arguments[c];
          C(a);
          for (c = 0; c < b; c++) L["@" + a[c]] = 1;
        };
        ...
        var R = {},
            ...
            if (!f)
              try {
                ...
                c =
                  ...
                  c +
                  (0 == e.indexOf("[Exception") && e.indexOf("data: no")
                    ? "\nwas not found.\n"
                    : "\ncould not be loaded. Script error: " +
                      h.message +
                      " \n\ndata:\n\n" +
                      e) +
                  "\n\n" +
          ...
          X = function (a) {
            window["j2s.script.debugging"] || window.setTimeout(V(a), 1);
          };
        a._4Name = function (c, d, e) {
          if (a.isClassDefined(c)) return a.evalType(c);
          d = m._isAsync && d ? d._restoreState(c, e) : null;
          if (1 == d) return null;
          if (b.setLoadingMode(d ? b.MODE_SCRIPT : "xhr.sync"))
            return b.loadClass(c, d, !1, !0, 1), null;
          b.loadClass(c);
          return a.evalType(c);
        };
        a.currentPath = "";
        var W = function (c, d, f, j, l) {
            a.currentPath = d;
            j && alert("WHY>>");
            j = e[d];
            e[d] = !0;
            ...
            if (l) {
                ...
                for (var q = 0; q < r.length; q++) {
                  ...
                  if (t != l.name && (m = G(t)))
                    m.status < x.STATUS_CONTENT_LOADED &&
                      ((m.status = x.STATUS_CONTENT_LOADED), updateNode(m));
                  else {
                    m = new x();
                    m.name = t;
                    var u = D["#" + t];
                    u ||
                      (alert(t + " J2S error in tryToLoadNext"),
                      error(
              ...
              if (l instanceof Array)
                for (q = 0; q < l.length; q++)
                  l[q].status < x.STATUS_CONTENT_LOADED &&
                    ((l[q].status = x.STATUS_CONTENT_LOADED), updateNode(l[q]));
                ...
                for (q = 0; q < r.length; q++)
                  if (s) {
                    if (
                      ...
                      r[q].onreadystatechange.path == l.path &&
                      "interactive" == r[q].readyState
                    ) {
                      m = !0;
                      break;
                    }
              ...
              if (b.keepOnLoading) {
                q = !0;
                if ((m = Ia(x.STATUS_KNOWN)))
                  for (Q(m); h < j && (m = Ia(x.STATUS_KNOWN)); ) Q(m);
                else if (0 != H.length)
                  (m = H.shift()),
                    !e[m.path] ||
                    0 != H.length ||
                    ...
                    m.musts.length ||
                    m.optionals.length
                      ? (Ha(d, m, !0), W(m, m.path, m.requiredBy, !1))
                      : ha && (ha = !1);
                else if ((m = F(x.STATUS_KNOWN)))
                  for (Q(m); h < j && (m = F(x.STATUS_KNOWN)); ) Q(m);
                else q = !1;
                if (!(q || 0 < h)) {
                  l = [Ia, F];
                  r = null;
                  for (q = 0; 2 > q; q++)
                    for (; (m = l[q](x.STATUS_CONTENT_LOADED)); )
                      1 == q && r === m && (m.status = x.STATUS_LOAD_COMPLETE),
                        updateNode(m),
                        (r = m);
                  for (; !((la = []), !ma(d, c)); );
                  for (q = 0; 2 > q; q++)
                    for (r = null; (m = l[q](x.STATUS_DECLARED)) && r !== m; )
                      updateNode((r = m));
                  r = [];
                  for (q = 0; 2 > q; q++)
                    for (; (m = l[q](x.STATUS_DECLARED)); )
                      r.push(m), (m.status = x.STATUS_LOAD_COMPLETE);
                  if (r.length) {
                  ...
                  if (f) f();
                    ...
                    for (t in b._classPending) {
                      if (
                        ((m = G(t)),
                        System.out.println("class left pending " + t + " " + m),
                        m)
                      ) {
                        updateNode(m);
                        break;
                    ...
                    b._checkLoad &&
                      (System.out.println(
                        "I think I'm done: SAEM call count: " + O
                      ),
                      a.showDuplicates(!0));
                  b.onGlobalLoaded();
                }
          ...
          ma = function (a, c) {
            ...
            for (
              var f = e;
              0 <= --f && !(d[f] === a && d[f].status >= x.STATUS_DECLARED);
            ...
            if (0 <= f) {
              ...
              for (; f < e; f++) {
                ...
                b._checkLoad &&
                  ((h =
                    "cycle setting status to LOAD_COMPLETE for " +
                    j.name +
                    (k ? " firing " + k.toString() : "")),
            ...
            for (h = 0; 2 > h; h++) {
              k = j[h];
              for (f = k.length; 0 <= --f; )
                if (k[f].status == x.STATUS_DECLARED && ma(k[f], c)) return !0;
            }
            d.length = e;
            return !1;
          };
        ...
        b.showPending = function () {
          ...
          for (c in b._classPending) {
            var d = G(c);
            d
              ? (a.push(d), System.out.println(ta("", "", d, "", 0)))
              : alert("No node for " + c);
          }
          return a;
        };
        var ta = function (a, b, c, d, e) {
          ...
          if (
            ...
            for (var f = 0; f < c.parents.length; f++)
              a = ta(a, b, c.parents[f], d + "\t", e + 1);
            a += "\n";
          }
          return a;
        };
        updateNode = function (a) {
          if (!a.name || a.status >= x.STATUS_LOAD_COMPLETE) Ba(a);
          else {
            var c = !0;
              ...
              for (var d = a.musts.length, e = d; 0 <= --e; ) {
                ...
                if (f.status < x.STATUS_DECLARED && isClassDefined(f.name)) {
                  ...
                  if (f.declaration && f.declaration.clazzList) {
                    for (
                      var j = 0, k = f.declaration.clazzList, l = k.length;
                      j < l;
                      j++
                    ) {
                      var m = G(k[j]);
                      m &&
                        m.status != x.STATUS_LOAD_COMPLETE &&
                        m !== f &&
                        ((m.status = f.status),
                        (m.declaration = null),
                        Ba(m),
                  ...
                  f.status == x.STATUS_CONTENT_LOADED && updateNode(f),
                    f.status < x.STATUS_DECLARED && (c = !1);
            ...
            if (c) {
              if (a.status < x.STATUS_DECLARED) {
                ...
                b._checkLoad &&
                  b._classPending[a.name] &&
                  (delete b._classPending[a.name],
                  b._classCountOK,
                  b._classCountPending--);
                ...
                if (a.declaration && a.declaration.clazzList) {
                  ...
                  for (l = k.length; j < l; j++)
                    if (
                      (m = G(k[j])) &&
                      m.status != x.STATUS_DECLARED &&
                      m !== a
                    )
                      (m.status = x.STATUS_DECLARED),
                        B && (B[m.name] = !0),
                        b.onScriptInitialized(m.path);
                }
              }
              c = x.STATUS_DECLARED;
              if (
                (0 == a.optionals.length && 0 == a.musts.length) ||
                (a.status > x.STATUS_KNOWN && !a.declaration) ||
                (Sa(a.musts, x.STATUS_LOAD_COMPLETE) &&
                  Sa(a.optionals, x.STATUS_LOAD_COMPLETE))
              ) {
                ...
                if (a.declaration && a.declaration.clazzList) {
                  ...
                  k = a.declaration.clazzList;
                  for (l = k.length; j < l; j++)
                    if ((m = G(k[j])) && m.status != c && m !== a)
                      if (((m.declaration = null), !ua(m, c))) return !1;
                }
              }
              if (a.parents && a.parents.length) {
                for (e = 0; e < a.parents.length; e++)
                  (j = a.parents[e]), j.status < c && updateNode(j, j.name);
        ...
        var Sa = function (a, b) {
            for (var c = a.length; 0 <= --c; ) if (a[c].status < b) return !1;
            return !0;
          },
          ua = function (a, c) {
            a.status = c;
          ...
          za = function () {
            for (;;) {
              var a = Math.random(),
                b = "r" + a;
              if (!wa[b]) return (wa[b] = 1), (d.random = a);
            }
          },
          G = function (a) {
            za();
          ...
          Ca = function (a, b) {
            ...
            return b.name == a
              ? b
              : (c = $a(a, b.musts)) || (c = $a(a, b.optionals))
              ? c
              : null;
          },
          $a = function (a, b) {
            for (var c = d.random, e = b.length; 0 <= --e; ) {
              ...
              if (
                f.name == a ||
                (f.random != c && ((f.random = c), (f = Ca(a, f))))
              )
                return f;
            }
            return null;
          ...
          ya = function (a, b) {
            return (
              a.status == b &&
              (b != x.STATUS_KNOWN || !e[a.path]) &&
              (b == x.STATUS_DECLARED || !isClassDefined(a.name))
            );
          },
          pa = function (a, b) {
            for (var c = a.musts.length; 0 <= --c; ) {
              var d = a.musts[c];
              if (ya(d, b) || (d = pa(d, b))) return d;
            }
            return ya(a, b) ? a : null;
          },
          Aa = function (a, b) {
            var c;
            return (c = na(a.musts, b)) ||
              (c = na(a.optionals, b)) ||
              ya((c = a), b)
              ? c
              : null;
          ...
          na = function (a, b) {
            if (a)
              for (var c = d.random, e = 0; e < a.length; e++) {
                ...
                if (
                  ya(f, b) ||
                  (f.random != c && ((f.random = c), (f = Aa(f, b))))
                )
                  return f;
              }
            return null;
          ...
          P = function (a, c, e, f) {
            if (c instanceof Array) {
              C(c);
              for (var h = 0; h < c.length; h++) P(a, c[h], e, f, c);
            } else {
              b._checkLoad &&
                !b._classPending[c] &&
                ((b._classPending[c] = 1),
                0 == b._classCountPending++ && (b._classCountOK = 0),
              ...
              h ||
                ...
                (h.path = D["#" + c] || "unknown"),
                Z(h.path, c, h),
                (h.status = x.STATUS_KNOWN),
                Ha(d, h, !1));
              ia(h, a, !0);
              5 == arguments.length &&
                f &&
                ((f.status = h.status), (f.clazzList = arguments[4]));
          ...
          ia = function (a, b, c) {
            if (b && b.length) {
              ...
              for (var d = 0; d < b.length; d++) {
                var e = b[d];
                if (e && !isClassDefined(e) && !L["@" + e]) {
                  var f = G(e);
                  f ||
                    ((f = new x()), (f.name = e), (f.status = x.STATUS_KNOWN));
                  f.requiredBy = a;
                  Ha(a, f, c);
                }
              }
        ...
        window.Clazz ? (a.load = P) : (b.load = P);
        var Z = function (a, b, c) {
          ...
          Q = function (a) {
            var c = a.name;
            if (!isClassDefined(c) && !L["@" + c]) {
              var d = b.getClasspathFor(c);
              a.path = d;
              Z(d, c, a);
              if (!e[d]) return W(a, d, a.requiredBy, !1), !0;
            }
            return !1;
          },
          ea = (b.runtimeKeyClass = "java.lang.String"),
          Ja = [];
        b.getJ2SLibBase = function () {
          ...
          return a
            ? a.base +
                ("." == a.alias
                  ? ""
                  : (a.alias ? a.alias : a.version ? a.version : "1.0.0") + "/")
            : null;
        };
        var ra = !0,
          I = !1,
        ...
        b.setLoadingMode = function (a, c) {
          ...
          "string" == typeof a
            ? ((a = a.toLowerCase()),
              0 <= a.indexOf("script") ? (e = !1) : a.indexOf("async"),
              (d = !1))
            : a & b.MODE_SCRIPT
            ? (e = !1)
            : (d = !(a & b.MODE_SYNC));
        ...
        var da = function () {
          if (!K && isClassDefined(ea)) {
            for (var a = Ja, c = 0; c < a.length; c++)
              b.loadClass(a[c][0], a[c][1]);
            Ja = [];
          }
        };
        b.loadZJar = function (a, c) {
          ...
          e ? (c = c[c.length - 1]) : (d = c == ea ? da : null);
        ...
        var Da = {},
          ...
          Ha = function (a, b, c) {
            var e = !1;
            c
              ? ((c = a.musts), b.requiredBy || (b.requiredBy = a))
              : (c = a.optionals);
            Da[b.name] || (Na.push(b), (Da[b.name] = b));
            ...
            a: {
              if (a.name && a != d && a != b)
                for (e = 0; e < b.parents.length; e++)
                  if (b.parents[e].name == a.name) break a;
              b.parents.push(a);
            }
          },
          Ba = function (a) {
            ...
            if (b)
              for (var c = b.length; 0 <= --c; )
                Ya(b[c].musts, a) || Ya(b[c].optionals, a);
          };
        a.binaryFolders = b.binaryFolders = [b.getJ2SLibBase()];
      })(a, a._Loader);
      a._LoaderProgressMonitor = {};
      var W = a._LoaderProgressMonitor,
        H = null,
        ga = 0,
        L = null,
        ua = 0;
      W.DEFAULT_OPACITY =
        m && m._j2sLoadMonitorOpacity ? m._j2sLoadMonitorOpacity : 55;
      W.hideMonitor = function () {
        L.style.display = "none";
      };
      W.showStatus = function (a, b) {
        if (!L) {
          var c = document.createElement("DIV");
          c.id = "_Loader-status";
          c.style.cssText =
            "position:absolute;bottom:4px;left:4px;padding:2px 8px;z-index:" +
            (window["j2s.lib"].monitorZIndex || 1e4) +
            ";background-color:#8e0000;color:yellow;font-family:Arial, sans-serif;font-size:10pt;white-space:nowrap;";
          c.onmouseover = ub;
          L = c;
        ...
        jb(L);
        if (null == a) b ? ma() : W.hideMonitor();
        else {
          L.appendChild(document.createTextNode("" + a));
          "none" == L.style.display && (L.style.display = "");
          kb(W.DEFAULT_OPACITY);
          var d,
            c = navigator.userAgent;
          d = document.body;
          var e = d.parentNode,
          ...
          var j = e.scrollTop + e.offsetTop,
            c =
              0 > c.indexOf("Opera") && document.all
                ? 0 == h
                  ? d
                  : j
                : 0 > c.indexOf("Gecko")
                ? h == e.offsetHeight && h == e.scrollHeight
                  ? d
                  : j
                : d;
          ua != c && ((ua = c), (L.style.bottom = ua + 4 + "px"));
          b && ma();
        }
      };
      var jb = function (a) {
        ...
        kb = function (a) {
          H && a == W.DEFAULT_OPACITY && (window.clearTimeout(H), (H = null));
          ga = a;
          navigator.userAgent.toLowerCase();
          L.style.filter = "Alpha(Opacity=" + a + ")";
          L.style.opacity = a / 100;
        },
        ub = function () {
          W.hideMonitor();
        },
        ...
        X = System;
      B.maxTotalLines = 1e4;
      B.setMaxTotalLines = function (a) {
        B.maxTotalLines = 0 < a ? a : 999999;
      };
      B.maxLatency = 40;
      B.setMaxLatency = function (a) {
        B.maxLatency = 0 < a ? a : 40;
      };
      B.pinning = !1;
      B.enablePinning = function (a) {
        B.pinning = a;
      };
      B.linesCount = 0;
      B.metLineBreak = !1;
      B.createConsoleWindow = function () {
      ...
      var ca = String.fromCharCode(160),
        ca = ca + (ca + ca + ca);
      B.consoleOutput = function (a, b) {
        var c = window["j2s.lib"];
        (c = c && c.console) &&
          "string" == typeof c &&
          (c = document.getElementById(c));
        if (!c) return !1;
        if (B.linesCount > B.maxTotalLines) {
          for (var d = 0; d < B.linesCount - B.maxTotalLines; d++)
            c && 0 < c.childNodes.length && c.removeChild(c.childNodes[0]);
          B.linesCount = B.maxTotalLines;
        }
        var e = !1;
        a = (
          "undefined" == typeof a ? "" : null == a ? "null" : "" + a
        ).replace(/\t/g, ca);
        if (0 < a.length)
            ...
            case "\r":
              (a =
                1 < a.length
                  ? a.substring(
                      0,
                      a.length - ("\r" == a.charAt(a.length - 2) ? 2 : 1)
                    )
                  : ""),
                (e = !0);
          }
        ...
        for (
          ...
          var l = null;
          if (B.metLineBreak || 0 == B.linesCount || 1 > c.childNodes.length)
          ...
          B.pinning || (c.scrollTop += 100);
          B.metLineBreak = d != j || e;
        }
        d = c.parentNode.className;
        !B.pinning &&
          d &&
          -1 != d.indexOf("composite") &&
          (c.parentNode.scrollTop = c.parentNode.scrollHeight);
        B.lastOutputTime = new Date().getTime();
      };
      B.clear = function () {
        try {
          B.metLineBreak = !0;
          ...
          if (b && (b = document.getElementById(b))) {
            for (var c = b.childNodes, d = c.length; 0 <= --d; )
              b.removeChild(c[d]);
            B.linesCount = 0;
          }
        } catch (e) {}
      ...
      X.out.print = function (a) {
        B.consoleOutput(a);
      };
      X.out.println = function (a) {
        B.consoleOutput(
          "undefined" == typeof a ? "\r\n" : null == a ? "null\r\n" : a + "\r\n"
        );
      };
      X.out.write = function (a, b, c) {
        X.out.print(String.instantialize(a).substring(b, b + c));
      };
      X.err.__CLASS_NAME__ = "java.io.PrintStream";
      X.err.print = function (a) {
        B.consoleOutput(a, "red");
      };
      X.err.println = function (a) {
        B.consoleOutput(
          "undefined" == typeof a
            ? "\r\n"
            : null == a
      ...
      X.err.write = function (a, b, c) {
        X.err.print(String.instantialize(a).substring(b, b + c));
      };
    })(Clazz, Jmol));
};
